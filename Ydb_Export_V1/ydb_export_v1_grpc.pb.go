...
func (c *exportServiceClient) ExportToYt(ctx context.Context, in *Ydb_Export.ExportToYtRequest, opts ...grpc.CallOption) (*Ydb_Export.ExportToYtResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExportService_ExportToYt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exportServiceClient) ExportToS3(ctx context.Context, in *Ydb_Export.ExportToS3Request, opts ...grpc.CallOption) (*Ydb_Export.ExportToS3Response, error) {
	...
	err := c.cc.Invoke(ctx, ExportService_ExportToS3_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExportServiceServer) ExportToYt(context.Context, *Ydb_Export.ExportToYtRequest) (*Ydb_Export.ExportToYtResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExportToYt not implemented")
}
func (UnimplementedExportServiceServer) ExportToS3(context.Context, *Ydb_Export.ExportToS3Request) (*Ydb_Export.ExportToS3Response, error) {
	return nil, status.Error(codes.Unimplemented, "method ExportToS3 not implemented")
}
func (UnimplementedExportServiceServer) ExportToFs(context.Context, *Ydb_Export.ExportToFsRequest) (*Ydb_Export.ExportToFsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExportToFs not implemented")
}
