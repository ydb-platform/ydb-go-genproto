...
func (QueryStatsCollection_Mode) EnumDescriptor() ([]byte, []int) {
	return file_protos_ydb_table_proto_rawDescGZIP(), []int{67, 0}
}
...
func (KeepAliveResult_SessionStatus) EnumDescriptor() ([]byte, []int) {
	return file_protos_ydb_table_proto_rawDescGZIP(), []int{83, 0}
}
...
func file_protos_ydb_table_proto_init() {
	...
	file_protos_ydb_table_proto_msgTypes[65].OneofWrappers = []interface{}{
		(*TransactionControl_TxId)(nil),
		(*TransactionControl_BeginTx)(nil),
	}
	file_protos_ydb_table_proto_msgTypes[102].OneofWrappers = []interface{}{
	...
	file_protos_ydb_table_proto_msgTypes[119].OneofWrappers = []interface{}{}
	file_protos_ydb_table_proto_msgTypes[126].OneofWrappers = []interface{}{}
	type x struct{}
