...
type TableIndex struct {
	...
	xxx_hidden_IndexColumns []string               `protobuf:"bytes,2,rep,name=index_columns,json=indexColumns"`
	xxx_hidden_Type         isTableIndex_Type      `protobuf_oneof:"type"`
	xxx_hidden_DataColumns  []string               `protobuf:"bytes,5,rep,name=data_columns,json=dataColumns"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
type TableIndexDescription struct {
	...
	xxx_hidden_Status       TableIndexDescription_Status `protobuf:"varint,4,opt,name=status,enum=Ydb.Table.TableIndexDescription_Status"`
	xxx_hidden_DataColumns  []string                     `protobuf:"bytes,6,rep,name=data_columns,json=dataColumns"`
...
func (x *TableIndexDescription) ClearStatus() {
	...
	x.xxx_hidden_Status = TableIndexDescription_STATUS_UNSPECIFIED
}
...
type IndexBuildDescription struct {
	...
	xxx_hidden_Index       *TableIndex            `protobuf:"bytes,2,opt,name=index"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type IndexBuildMetadata struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Description *IndexBuildDescription `protobuf:"bytes,1,opt,name=description"`
	xxx_hidden_State       IndexBuildState_State  `protobuf:"varint,2,opt,name=state,enum=Ydb.Table.IndexBuildState_State"`
...
func (x *IndexBuildMetadata) ClearState() {
	...
	x.xxx_hidden_State = IndexBuildState_STATE_UNSPECIFIED
}
...
type Changefeed struct {
	state                                 protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_Name                       *string                         `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_Mode                       ChangefeedMode_Mode             `protobuf:"varint,2,opt,name=mode,enum=Ydb.Table.ChangefeedMode_Mode"`
	xxx_hidden_Format                     ChangefeedFormat_Format         `protobuf:"varint,3,opt,name=format,enum=Ydb.Table.ChangefeedFormat_Format"`
	xxx_hidden_RetentionPeriod            *durationpb.Duration            `protobuf:"bytes,4,opt,name=retention_period,json=retentionPeriod"`
	xxx_hidden_VirtualTimestamps          bool                            `protobuf:"varint,5,opt,name=virtual_timestamps,json=virtualTimestamps"`
	xxx_hidden_InitialScan                bool                            `protobuf:"varint,6,opt,name=initial_scan,json=initialScan"`
	...
	xxx_hidden_AwsRegion                  *string                         `protobuf:"bytes,8,opt,name=aws_region,json=awsRegion"`
	xxx_hidden_ResolvedTimestampsInterval *durationpb.Duration            `protobuf:"bytes,9,opt,name=resolved_timestamps_interval,json=resolvedTimestampsInterval"`
	xxx_hidden_TopicPartitioningSettings  *Ydb_Topic.PartitioningSettings `protobuf:"bytes,10,opt,name=topic_partitioning_settings,json=topicPartitioningSettings"`
	XXX_raceDetectHookData                protoimpl.RaceDetectHookData
	XXX_presence                          [1]uint32
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
...
func (x *Changefeed) ClearMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_Mode = ChangefeedMode_MODE_UNSPECIFIED
}

func (x *Changefeed) ClearFormat() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_Format = ChangefeedFormat_FORMAT_UNSPECIFIED
}
...
func (x *Changefeed) ClearVirtualTimestamps() {
	...
	x.xxx_hidden_VirtualTimestamps = false
}

func (x *Changefeed) ClearInitialScan() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_InitialScan = false
}

func (x *Changefeed) ClearAwsRegion() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 7)
	x.xxx_hidden_AwsRegion = nil
}
...
type ChangefeedDescription struct {
	...
	xxx_hidden_Mode                       ChangefeedMode_Mode         `protobuf:"varint,2,opt,name=mode,enum=Ydb.Table.ChangefeedMode_Mode"`
	xxx_hidden_Format                     ChangefeedFormat_Format     `protobuf:"varint,3,opt,name=format,enum=Ydb.Table.ChangefeedFormat_Format"`
	xxx_hidden_State                      ChangefeedDescription_State `protobuf:"varint,4,opt,name=state,enum=Ydb.Table.ChangefeedDescription_State"`
	xxx_hidden_VirtualTimestamps          bool                        `protobuf:"varint,5,opt,name=virtual_timestamps,json=virtualTimestamps"`
	...
	xxx_hidden_AwsRegion                  *string                     `protobuf:"bytes,7,opt,name=aws_region,json=awsRegion"`
	xxx_hidden_ResolvedTimestampsInterval *durationpb.Duration        `protobuf:"bytes,8,opt,name=resolved_timestamps_interval,json=resolvedTimestampsInterval"`
	XXX_raceDetectHookData                protoimpl.RaceDetectHookData
	XXX_presence                          [1]uint32
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
...
func (x *ChangefeedDescription) ClearState() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_State = ChangefeedDescription_STATE_UNSPECIFIED
}
...
type StoragePolicy struct {
	...
	xxx_hidden_Syslog         *StoragePool           `protobuf:"bytes,2,opt,name=syslog"`
	xxx_hidden_Log            *StoragePool           `protobuf:"bytes,3,opt,name=log"`
	xxx_hidden_Data           *StoragePool           `protobuf:"bytes,4,opt,name=data"`
	xxx_hidden_External       *StoragePool           `protobuf:"bytes,5,opt,name=external"`
	xxx_hidden_KeepInMemory   Ydb.FeatureFlag_Status `protobuf:"varint,6,opt,name=keep_in_memory,json=keepInMemory,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_ColumnFamilies *[]*ColumnFamilyPolicy `protobuf:"bytes,7,rep,name=column_families,json=columnFamilies"`
	XXX_raceDetectHookData    protoimpl.RaceDetectHookData
	XXX_presence              [1]uint32
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
...
func (x *StoragePolicy) ClearKeepInMemory() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_KeepInMemory = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}
...
type ColumnFamilyPolicy struct {
	state                   protoimpl.MessageState         `protogen:"opaque.v1"`
	xxx_hidden_Name         *string                        `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_Data         *StoragePool                   `protobuf:"bytes,2,opt,name=data"`
	xxx_hidden_External     *StoragePool                   `protobuf:"bytes,3,opt,name=external"`
	xxx_hidden_KeepInMemory Ydb.FeatureFlag_Status         `protobuf:"varint,4,opt,name=keep_in_memory,json=keepInMemory,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_Compression  ColumnFamilyPolicy_Compression `protobuf:"varint,5,opt,name=compression,enum=Ydb.Table.ColumnFamilyPolicy_Compression"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *ColumnFamilyPolicy) ClearCompression() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_Compression = ColumnFamilyPolicy_COMPRESSION_UNSPECIFIED
}
...
type ExplicitPartitions struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SplitPoints *[]*Ydb.TypedValue     `protobuf:"bytes,1,rep,name=split_points,json=splitPoints"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type PartitionStats struct {
	state                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RowsEstimate uint64                 `protobuf:"varint,1,opt,name=rows_estimate,json=rowsEstimate"`
	xxx_hidden_StoreSize    uint64                 `protobuf:"varint,2,opt,name=store_size,json=storeSize"`
	xxx_hidden_LeaderNodeId uint32                 `protobuf:"varint,3,opt,name=leader_node_id,json=leaderNodeId"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *PartitionStats) ClearRowsEstimate() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_RowsEstimate = 0
}

func (x *PartitionStats) ClearStoreSize() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_StoreSize = 0
}

func (x *PartitionStats) ClearLeaderNodeId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_LeaderNodeId = 0
}
...
type TableStats struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionStats   *[]*PartitionStats     `protobuf:"bytes,1,rep,name=partition_stats,json=partitionStats"`
	xxx_hidden_RowsEstimate     uint64                 `protobuf:"varint,2,opt,name=rows_estimate,json=rowsEstimate"`
	xxx_hidden_StoreSize        uint64                 `protobuf:"varint,3,opt,name=store_size,json=storeSize"`
	xxx_hidden_Partitions       uint64                 `protobuf:"varint,4,opt,name=partitions"`
	xxx_hidden_CreationTime     *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=creation_time,json=creationTime"`
	xxx_hidden_ModificationTime *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=modification_time,json=modificationTime"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
type PartitioningPolicy struct {
	state                       protoimpl.MessageState                    `protogen:"opaque.v1"`
	xxx_hidden_PresetName       *string                                   `protobuf:"bytes,1,opt,name=preset_name,json=presetName"`
	xxx_hidden_AutoPartitioning PartitioningPolicy_AutoPartitioningPolicy `protobuf:"varint,2,opt,name=auto_partitioning,json=autoPartitioning,enum=Ydb.Table.PartitioningPolicy_AutoPartitioningPolicy"`
...
func (x *PartitioningPolicy) ClearAutoPartitioning() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_AutoPartitioning = PartitioningPolicy_AUTO_PARTITIONING_POLICY_UNSPECIFIED
}
...
type ReplicationPolicy struct {
	state                                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PresetName                *string                `protobuf:"bytes,1,opt,name=preset_name,json=presetName"`
	xxx_hidden_ReplicasCount             uint32                 `protobuf:"varint,2,opt,name=replicas_count,json=replicasCount"`
	xxx_hidden_CreatePerAvailabilityZone Ydb.FeatureFlag_Status `protobuf:"varint,3,opt,name=create_per_availability_zone,json=createPerAvailabilityZone,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_AllowPromotion            Ydb.FeatureFlag_Status `protobuf:"varint,4,opt,name=allow_promotion,json=allowPromotion,enum=Ydb.FeatureFlag_Status"`
	XXX_raceDetectHookData               protoimpl.RaceDetectHookData
	XXX_presence                         [1]uint32
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
...
func (x *ReplicationPolicy) ClearReplicasCount() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_ReplicasCount = 0
}

func (x *ReplicationPolicy) ClearCreatePerAvailabilityZone() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_CreatePerAvailabilityZone = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}

func (x *ReplicationPolicy) ClearAllowPromotion() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_AllowPromotion = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}
...
type TableProfile struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PresetName         *string                `protobuf:"bytes,1,opt,name=preset_name,json=presetName"`
	xxx_hidden_StoragePolicy      *StoragePolicy         `protobuf:"bytes,2,opt,name=storage_policy,json=storagePolicy"`
	xxx_hidden_CompactionPolicy   *CompactionPolicy      `protobuf:"bytes,3,opt,name=compaction_policy,json=compactionPolicy"`
	xxx_hidden_PartitioningPolicy *PartitioningPolicy    `protobuf:"bytes,4,opt,name=partitioning_policy,json=partitioningPolicy"`
	xxx_hidden_ExecutionPolicy    *ExecutionPolicy       `protobuf:"bytes,5,opt,name=execution_policy,json=executionPolicy"`
	xxx_hidden_ReplicationPolicy  *ReplicationPolicy     `protobuf:"bytes,6,opt,name=replication_policy,json=replicationPolicy"`
	xxx_hidden_CachingPolicy      *CachingPolicy         `protobuf:"bytes,7,opt,name=caching_policy,json=cachingPolicy"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type SequenceDescription struct {
	state                  protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_Name        *string                     `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_MinValue    int64                       `protobuf:"zigzag64,2,opt,name=min_value,json=minValue"`
	xxx_hidden_MaxValue    int64                       `protobuf:"zigzag64,3,opt,name=max_value,json=maxValue"`
	xxx_hidden_StartValue  int64                       `protobuf:"zigzag64,4,opt,name=start_value,json=startValue"`
	xxx_hidden_Cache       uint64                      `protobuf:"varint,5,opt,name=cache"`
	xxx_hidden_Increment   int64                       `protobuf:"zigzag64,6,opt,name=increment"`
	xxx_hidden_Cycle       bool                        `protobuf:"varint,7,opt,name=cycle"`
	xxx_hidden_SetVal      *SequenceDescription_SetVal `protobuf:"bytes,8,opt,name=set_val,json=setVal"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ColumnMeta struct {
	state                   protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Name         *string                   `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_Type         *Ydb.Type                 `protobuf:"bytes,2,opt,name=type"`
	xxx_hidden_Family       *string                   `protobuf:"bytes,3,opt,name=family"`
	xxx_hidden_NotNull      bool                      `protobuf:"varint,4,opt,name=not_null,json=notNull"`
...
type DateTypeColumnModeSettings struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ColumnName         *string                `protobuf:"bytes,1,opt,name=column_name,json=columnName"`
	xxx_hidden_ExpireAfterSeconds uint32                 `protobuf:"varint,2,opt,name=expire_after_seconds,json=expireAfterSeconds"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *DateTypeColumnModeSettings) GetColumnName() string {
	if x != nil {
		if x.xxx_hidden_ColumnName != nil {
...
func (x *DateTypeColumnModeSettings) ClearColumnName() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_ColumnName = nil
}

func (x *DateTypeColumnModeSettings) ClearExpireAfterSeconds() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_ExpireAfterSeconds = 0
}
...
type ValueSinceUnixEpochModeSettings struct {
	state                         protoimpl.MessageState               `protogen:"opaque.v1"`
	xxx_hidden_ColumnName         *string                              `protobuf:"bytes,1,opt,name=column_name,json=columnName"`
	xxx_hidden_ColumnUnit         ValueSinceUnixEpochModeSettings_Unit `protobuf:"varint,2,opt,name=column_unit,json=columnUnit,enum=Ydb.Table.ValueSinceUnixEpochModeSettings_Unit"`
	xxx_hidden_ExpireAfterSeconds uint32                               `protobuf:"varint,3,opt,name=expire_after_seconds,json=expireAfterSeconds"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *ValueSinceUnixEpochModeSettings) ClearColumnUnit() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_ColumnUnit = ValueSinceUnixEpochModeSettings_UNIT_UNSPECIFIED
}
...
type TtlSettings struct {
	...
	xxx_hidden_RunIntervalSeconds uint32                 `protobuf:"varint,3,opt,name=run_interval_seconds,json=runIntervalSeconds"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *TtlSettings) ClearRunIntervalSeconds() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_RunIntervalSeconds = 0
}
...
type StorageSettings struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TabletCommitLog0   *StoragePool           `protobuf:"bytes,1,opt,name=tablet_commit_log0,json=tabletCommitLog0"`
	xxx_hidden_TabletCommitLog1   *StoragePool           `protobuf:"bytes,2,opt,name=tablet_commit_log1,json=tabletCommitLog1"`
	xxx_hidden_External           *StoragePool           `protobuf:"bytes,4,opt,name=external"`
	xxx_hidden_StoreExternalBlobs Ydb.FeatureFlag_Status `protobuf:"varint,5,opt,name=store_external_blobs,json=storeExternalBlobs,enum=Ydb.FeatureFlag_Status"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *StorageSettings) ClearStoreExternalBlobs() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_StoreExternalBlobs = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}
...
type ColumnFamily struct {
	...
	xxx_hidden_Name         *string                  `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_Data         *StoragePool             `protobuf:"bytes,2,opt,name=data"`
	xxx_hidden_Compression  ColumnFamily_Compression `protobuf:"varint,3,opt,name=compression,enum=Ydb.Table.ColumnFamily_Compression"`
	xxx_hidden_KeepInMemory Ydb.FeatureFlag_Status   `protobuf:"varint,4,opt,name=keep_in_memory,json=keepInMemory,enum=Ydb.FeatureFlag_Status"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
...
func (x *ColumnFamily) ClearCompression() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_Compression = ColumnFamily_COMPRESSION_UNSPECIFIED
}
...
type PartitioningSettings struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionBy        []string               `protobuf:"bytes,1,rep,name=partition_by,json=partitionBy"`
	xxx_hidden_PartitioningBySize Ydb.FeatureFlag_Status `protobuf:"varint,2,opt,name=partitioning_by_size,json=partitioningBySize,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_PartitionSizeMb    uint64                 `protobuf:"varint,3,opt,name=partition_size_mb,json=partitionSizeMb"`
	xxx_hidden_PartitioningByLoad Ydb.FeatureFlag_Status `protobuf:"varint,4,opt,name=partitioning_by_load,json=partitioningByLoad,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_MinPartitionsCount uint64                 `protobuf:"varint,6,opt,name=min_partitions_count,json=minPartitionsCount"`
	xxx_hidden_MaxPartitionsCount uint64                 `protobuf:"varint,7,opt,name=max_partitions_count,json=maxPartitionsCount"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *PartitioningSettings) ClearPartitioningBySize() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_PartitioningBySize = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}

func (x *PartitioningSettings) ClearPartitionSizeMb() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_PartitionSizeMb = 0
}

func (x *PartitioningSettings) ClearPartitioningByLoad() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_PartitioningByLoad = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}

func (x *PartitioningSettings) ClearMinPartitionsCount() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_MinPartitionsCount = 0
}

func (x *PartitioningSettings) ClearMaxPartitionsCount() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_MaxPartitionsCount = 0
}
...
type AzReadReplicasSettings struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Name              *string                `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_ReadReplicasCount uint64                 `protobuf:"varint,2,opt,name=read_replicas_count,json=readReplicasCount"`
	XXX_raceDetectHookData       protoimpl.RaceDetectHookData
	XXX_presence                 [1]uint32
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
...
func (x *AzReadReplicasSettings) ClearReadReplicasCount() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_ReadReplicasCount = 0
}
...
type ClusterReplicasSettings struct {
	state                             protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_AzReadReplicasSettings *[]*AzReadReplicasSettings `protobuf:"bytes,2,rep,name=az_read_replicas_settings,json=azReadReplicasSettings"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
type CreateTableRequest struct {
	...
	xxx_hidden_Columns              *[]*ColumnMeta                  `protobuf:"bytes,3,rep,name=columns"`
	xxx_hidden_PrimaryKey           []string                        `protobuf:"bytes,4,rep,name=primary_key,json=primaryKey"`
	xxx_hidden_Profile              *TableProfile                   `protobuf:"bytes,5,opt,name=profile"`
	xxx_hidden_OperationParams      *Ydb_Operations.OperationParams `protobuf:"bytes,6,opt,name=operation_params,json=operationParams"`
	xxx_hidden_Indexes              *[]*TableIndex                  `protobuf:"bytes,7,rep,name=indexes"`
	xxx_hidden_TtlSettings          *TtlSettings                    `protobuf:"bytes,8,opt,name=ttl_settings,json=ttlSettings"`
	xxx_hidden_StorageSettings      *StorageSettings                `protobuf:"bytes,9,opt,name=storage_settings,json=storageSettings"`
	xxx_hidden_ColumnFamilies       *[]*ColumnFamily                `protobuf:"bytes,10,rep,name=column_families,json=columnFamilies"`
	xxx_hidden_Attributes           map[string]string               `protobuf:"bytes,11,rep,name=attributes" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_CompactionPolicy     *string                         `protobuf:"bytes,12,opt,name=compaction_policy,json=compactionPolicy"`
	xxx_hidden_Partitions           isCreateTableRequest_Partitions `protobuf_oneof:"partitions"`
	xxx_hidden_PartitioningSettings *PartitioningSettings           `protobuf:"bytes,15,opt,name=partitioning_settings,json=partitioningSettings"`
	xxx_hidden_KeyBloomFilter       Ydb.FeatureFlag_Status          `protobuf:"varint,16,opt,name=key_bloom_filter,json=keyBloomFilter,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_ReadReplicasSettings *ReadReplicasSettings           `protobuf:"bytes,17,opt,name=read_replicas_settings,json=readReplicasSettings"`
	xxx_hidden_Tiering              *string                         `protobuf:"bytes,18,opt,name=tiering"`
	xxx_hidden_Temporary            bool                            `protobuf:"varint,19,opt,name=temporary"`
	xxx_hidden_StoreType            StoreType                       `protobuf:"varint,20,opt,name=store_type,json=storeType,enum=Ydb.Table.StoreType"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
func (x *CreateTableRequest) GetCompactionPolicy() string {
	if x != nil {
		if x.xxx_hidden_CompactionPolicy != nil {
			return *x.xxx_hidden_CompactionPolicy
		}
		return ""
	}
...
func (x *CreateTableRequest) ClearKeyBloomFilter() {
	...
	x.xxx_hidden_KeyBloomFilter = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}
...
func (x *CreateTableRequest) ClearStoreType() {
	...
	x.xxx_hidden_StoreType = StoreType_STORE_TYPE_UNSPECIFIED
}
...
type DropTableRequest struct {
	...
	xxx_hidden_SessionId       *string                         `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_Path            *string                         `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,4,opt,name=operation_params,json=operationParams"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type RenameIndexItem struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SourceName         *string                `protobuf:"bytes,1,opt,name=source_name,json=sourceName"`
	xxx_hidden_DestinationName    *string                `protobuf:"bytes,2,opt,name=destination_name,json=destinationName"`
	xxx_hidden_ReplaceDestination bool                   `protobuf:"varint,3,opt,name=replace_destination,json=replaceDestination"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *RenameIndexItem) GetDestinationName() string {
	if x != nil {
		if x.xxx_hidden_DestinationName != nil {
...
func (x *RenameIndexItem) ClearDestinationName() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_DestinationName = nil
}

func (x *RenameIndexItem) ClearReplaceDestination() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_ReplaceDestination = false
}
...
func (b0 RenameIndexItem_builder) Build() *RenameIndexItem {
	...
	if b.DestinationName != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 1, 3)
		x.xxx_hidden_DestinationName = b.DestinationName
	}
	if b.ReplaceDestination != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 3)
...
type AlterTableRequest struct {
	...
	xxx_hidden_SessionId                 *string                           `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_Path                      *string                           `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_AddColumns                *[]*ColumnMeta                    `protobuf:"bytes,3,rep,name=add_columns,json=addColumns"`
	xxx_hidden_DropColumns               []string                          `protobuf:"bytes,4,rep,name=drop_columns,json=dropColumns"`
	xxx_hidden_OperationParams           *Ydb_Operations.OperationParams   `protobuf:"bytes,5,opt,name=operation_params,json=operationParams"`
	xxx_hidden_AlterColumns              *[]*ColumnMeta                    `protobuf:"bytes,6,rep,name=alter_columns,json=alterColumns"`
	xxx_hidden_TtlAction                 isAlterTableRequest_TtlAction     `protobuf_oneof:"ttl_action"`
	xxx_hidden_AddIndexes                *[]*TableIndex                    `protobuf:"bytes,9,rep,name=add_indexes,json=addIndexes"`
	xxx_hidden_DropIndexes               []string                          `protobuf:"bytes,10,rep,name=drop_indexes,json=dropIndexes"`
	xxx_hidden_AlterStorageSettings      *StorageSettings                  `protobuf:"bytes,11,opt,name=alter_storage_settings,json=alterStorageSettings"`
	xxx_hidden_AddColumnFamilies         *[]*ColumnFamily                  `protobuf:"bytes,12,rep,name=add_column_families,json=addColumnFamilies"`
	xxx_hidden_AlterColumnFamilies       *[]*ColumnFamily                  `protobuf:"bytes,13,rep,name=alter_column_families,json=alterColumnFamilies"`
	xxx_hidden_AlterAttributes           map[string]string                 `protobuf:"bytes,14,rep,name=alter_attributes,json=alterAttributes" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_SetCompactionPolicy       *string                           `protobuf:"bytes,15,opt,name=set_compaction_policy,json=setCompactionPolicy"`
	xxx_hidden_AlterPartitioningSettings *PartitioningSettings             `protobuf:"bytes,16,opt,name=alter_partitioning_settings,json=alterPartitioningSettings"`
	xxx_hidden_SetKeyBloomFilter         Ydb.FeatureFlag_Status            `protobuf:"varint,17,opt,name=set_key_bloom_filter,json=setKeyBloomFilter,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_SetReadReplicasSettings   *ReadReplicasSettings             `protobuf:"bytes,18,opt,name=set_read_replicas_settings,json=setReadReplicasSettings"`
	xxx_hidden_AddChangefeeds            *[]*Changefeed                    `protobuf:"bytes,19,rep,name=add_changefeeds,json=addChangefeeds"`
	xxx_hidden_DropChangefeeds           []string                          `protobuf:"bytes,20,rep,name=drop_changefeeds,json=dropChangefeeds"`
	xxx_hidden_RenameIndexes             *[]*RenameIndexItem               `protobuf:"bytes,21,rep,name=rename_indexes,json=renameIndexes"`
...
func (x *AlterTableRequest) GetSetCompactionPolicy() string {
	if x != nil {
		if x.xxx_hidden_SetCompactionPolicy != nil {
...
func (x *AlterTableRequest) ClearSetCompactionPolicy() {
	...
	x.xxx_hidden_SetCompactionPolicy = nil
}
...
func (x *AlterTableRequest) ClearSetKeyBloomFilter() {
	...
	x.xxx_hidden_SetKeyBloomFilter = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}
...
type CopyTableRequest struct {
	...
	xxx_hidden_DestinationPath *string                         `protobuf:"bytes,3,opt,name=destination_path,json=destinationPath"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,4,opt,name=operation_params,json=operationParams"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
...
type CopyTableItem struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SourcePath      *string                `protobuf:"bytes,1,opt,name=source_path,json=sourcePath"`
	xxx_hidden_DestinationPath *string                `protobuf:"bytes,2,opt,name=destination_path,json=destinationPath"`
	xxx_hidden_OmitIndexes     bool                   `protobuf:"varint,3,opt,name=omit_indexes,json=omitIndexes"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
func (x *CopyTableItem) ClearOmitIndexes() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_OmitIndexes = false
}
...
type CopyTablesRequest struct {
	...
	xxx_hidden_Tables          *[]*CopyTableItem               `protobuf:"bytes,3,rep,name=tables"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type RenameTablesRequest struct {
	...
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_SessionId       *string                         `protobuf:"bytes,2,opt,name=session_id,json=sessionId"`
	xxx_hidden_Tables          *[]*RenameTableItem             `protobuf:"bytes,3,rep,name=tables"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type DescribeTableRequest struct {
	...
	xxx_hidden_Path                  *string                         `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_OperationParams       *Ydb_Operations.OperationParams `protobuf:"bytes,4,opt,name=operation_params,json=operationParams"`
	xxx_hidden_IncludeShardKeyBounds bool                            `protobuf:"varint,5,opt,name=include_shard_key_bounds,json=includeShardKeyBounds"`
	xxx_hidden_IncludeTableStats     bool                            `protobuf:"varint,6,opt,name=include_table_stats,json=includeTableStats"`
	xxx_hidden_IncludePartitionStats bool                            `protobuf:"varint,7,opt,name=include_partition_stats,json=includePartitionStats"`
	xxx_hidden_IncludeShardNodesInfo bool                            `protobuf:"varint,9,opt,name=include_shard_nodes_info,json=includeShardNodesInfo"`
	XXX_raceDetectHookData           protoimpl.RaceDetectHookData
	XXX_presence                     [1]uint32
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
...
type DescribeTableResult struct {
	state                           protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Self                 *Ydb_Scheme.Entry         `protobuf:"bytes,1,opt,name=self"`
	xxx_hidden_Columns              *[]*ColumnMeta            `protobuf:"bytes,2,rep,name=columns"`
	xxx_hidden_PrimaryKey           []string                  `protobuf:"bytes,3,rep,name=primary_key,json=primaryKey"`
	xxx_hidden_ShardKeyBounds       *[]*Ydb.TypedValue        `protobuf:"bytes,4,rep,name=shard_key_bounds,json=shardKeyBounds"`
	xxx_hidden_Indexes              *[]*TableIndexDescription `protobuf:"bytes,5,rep,name=indexes"`
	xxx_hidden_TableStats           *TableStats               `protobuf:"bytes,6,opt,name=table_stats,json=tableStats"`
	xxx_hidden_TtlSettings          *TtlSettings              `protobuf:"bytes,7,opt,name=ttl_settings,json=ttlSettings"`
	xxx_hidden_StorageSettings      *StorageSettings          `protobuf:"bytes,8,opt,name=storage_settings,json=storageSettings"`
	xxx_hidden_ColumnFamilies       *[]*ColumnFamily          `protobuf:"bytes,9,rep,name=column_families,json=columnFamilies"`
	...
	xxx_hidden_PartitioningSettings *PartitioningSettings     `protobuf:"bytes,12,opt,name=partitioning_settings,json=partitioningSettings"`
	xxx_hidden_KeyBloomFilter       Ydb.FeatureFlag_Status    `protobuf:"varint,13,opt,name=key_bloom_filter,json=keyBloomFilter,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_ReadReplicasSettings *ReadReplicasSettings     `protobuf:"bytes,14,opt,name=read_replicas_settings,json=readReplicasSettings"`
	xxx_hidden_Changefeeds          *[]*ChangefeedDescription `protobuf:"bytes,15,rep,name=changefeeds"`
	xxx_hidden_Tiering              *string                   `protobuf:"bytes,16,opt,name=tiering"`
	xxx_hidden_Temporary            bool                      `protobuf:"varint,17,opt,name=temporary"`
	xxx_hidden_StoreType            StoreType                 `protobuf:"varint,18,opt,name=store_type,json=storeType,enum=Ydb.Table.StoreType"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
type QueryCachePolicy struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_KeepInCache bool                   `protobuf:"varint,1,opt,name=keep_in_cache,json=keepInCache"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *QueryCachePolicy) ClearKeepInCache() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_KeepInCache = false
}
...
type ExecuteDataQueryRequest struct {
	state                       protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_SessionId        *string                         `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_TxControl        *TransactionControl             `protobuf:"bytes,2,opt,name=tx_control,json=txControl"`
	xxx_hidden_Query            *Query                          `protobuf:"bytes,3,opt,name=query"`
	...
	xxx_hidden_QueryCachePolicy *QueryCachePolicy               `protobuf:"bytes,5,opt,name=query_cache_policy,json=queryCachePolicy"`
	xxx_hidden_OperationParams  *Ydb_Operations.OperationParams `protobuf:"bytes,6,opt,name=operation_params,json=operationParams"`
	xxx_hidden_CollectStats     QueryStatsCollection_Mode       `protobuf:"varint,7,opt,name=collect_stats,json=collectStats,enum=Ydb.Table.QueryStatsCollection_Mode"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *ExecuteDataQueryRequest) ClearCollectStats() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 6)
	x.xxx_hidden_CollectStats = QueryStatsCollection_STATS_COLLECTION_UNSPECIFIED
}
...
type ExecuteSchemeQueryRequest struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_SessionId       *string                         `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_YqlText         *string                         `protobuf:"bytes,2,opt,name=yql_text,json=yqlText"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,3,opt,name=operation_params,json=operationParams"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type QueryMeta struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Id              *string                `protobuf:"bytes,1,opt,name=id"`
	xxx_hidden_ParametersTypes map[string]*Ydb.Type   `protobuf:"bytes,2,rep,name=parameters_types,json=parametersTypes" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type ExecuteQueryResult struct {
	...
	xxx_hidden_TxMeta     *TransactionMeta           `protobuf:"bytes,2,opt,name=tx_meta,json=txMeta"`
	xxx_hidden_QueryMeta  *QueryMeta                 `protobuf:"bytes,3,opt,name=query_meta,json=queryMeta"`
	xxx_hidden_QueryStats *Ydb_TableStats.QueryStats `protobuf:"bytes,4,opt,name=query_stats,json=queryStats"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type ExplainDataQueryRequest struct {
	...
	xxx_hidden_YqlText                *string                         `protobuf:"bytes,2,opt,name=yql_text,json=yqlText"`
	xxx_hidden_OperationParams        *Ydb_Operations.OperationParams `protobuf:"bytes,3,opt,name=operation_params,json=operationParams"`
	xxx_hidden_CollectFullDiagnostics bool                            `protobuf:"varint,4,opt,name=collect_full_diagnostics,json=collectFullDiagnostics"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
func (x *ExplainDataQueryRequest) ClearCollectFullDiagnostics() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_CollectFullDiagnostics = false
}
...
func (b0 ExplainDataQueryRequest_builder) Build() *ExplainDataQueryRequest {
	...
	x.xxx_hidden_OperationParams = b.OperationParams
	if b.CollectFullDiagnostics != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 3, 4)
...
type ExplainQueryResult struct {
	state                           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_QueryAst             *string                `protobuf:"bytes,1,opt,name=query_ast,json=queryAst"`
	xxx_hidden_QueryPlan            *string                `protobuf:"bytes,2,opt,name=query_plan,json=queryPlan"`
	xxx_hidden_QueryFullDiagnostics *string                `protobuf:"bytes,3,opt,name=query_full_diagnostics,json=queryFullDiagnostics"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
func (x *ExplainQueryResult) GetQueryFullDiagnostics() string {
	if x != nil {
		if x.xxx_hidden_QueryFullDiagnostics != nil {
...
func (x *ExplainQueryResult) ClearQueryFullDiagnostics() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_QueryFullDiagnostics = nil
}
...
type KeepAliveResult struct {
	state                    protoimpl.MessageState        `protogen:"opaque.v1"`
	xxx_hidden_SessionStatus KeepAliveResult_SessionStatus `protobuf:"varint,1,opt,name=session_status,json=sessionStatus,enum=Ydb.Table.KeepAliveResult_SessionStatus"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *KeepAliveResult) ClearSessionStatus() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_SessionStatus = KeepAliveResult_SESSION_STATUS_UNSPECIFIED
}
...
type BeginTransactionResult struct {
	state             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TxMeta *TransactionMeta       `protobuf:"bytes,1,opt,name=tx_meta,json=txMeta"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type CommitTransactionRequest struct {
	...
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,3,opt,name=operation_params,json=operationParams"`
	xxx_hidden_CollectStats    QueryStatsCollection_Mode       `protobuf:"varint,4,opt,name=collect_stats,json=collectStats,enum=Ydb.Table.QueryStatsCollection_Mode"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type CommitTransactionResult struct {
	state                 protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_QueryStats *Ydb_TableStats.QueryStats `protobuf:"bytes,1,opt,name=query_stats,json=queryStats"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type TableProfileDescription struct {
	...
	xxx_hidden_Name                        *string                `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_Labels                      map[string]string      `protobuf:"bytes,2,rep,name=labels" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_DefaultStoragePolicy        *string                `protobuf:"bytes,3,opt,name=default_storage_policy,json=defaultStoragePolicy"`
	xxx_hidden_AllowedStoragePolicies      []string               `protobuf:"bytes,4,rep,name=allowed_storage_policies,json=allowedStoragePolicies"`
	xxx_hidden_DefaultCompactionPolicy     *string                `protobuf:"bytes,5,opt,name=default_compaction_policy,json=defaultCompactionPolicy"`
	xxx_hidden_AllowedCompactionPolicies   []string               `protobuf:"bytes,6,rep,name=allowed_compaction_policies,json=allowedCompactionPolicies"`
	xxx_hidden_DefaultPartitioningPolicy   *string                `protobuf:"bytes,7,opt,name=default_partitioning_policy,json=defaultPartitioningPolicy"`
	xxx_hidden_AllowedPartitioningPolicies []string               `protobuf:"bytes,8,rep,name=allowed_partitioning_policies,json=allowedPartitioningPolicies"`
	xxx_hidden_DefaultExecutionPolicy      *string                `protobuf:"bytes,9,opt,name=default_execution_policy,json=defaultExecutionPolicy"`
	xxx_hidden_AllowedExecutionPolicies    []string               `protobuf:"bytes,10,rep,name=allowed_execution_policies,json=allowedExecutionPolicies"`
	xxx_hidden_DefaultReplicationPolicy    *string                `protobuf:"bytes,11,opt,name=default_replication_policy,json=defaultReplicationPolicy"`
	xxx_hidden_AllowedReplicationPolicies  []string               `protobuf:"bytes,12,rep,name=allowed_replication_policies,json=allowedReplicationPolicies"`
	xxx_hidden_DefaultCachingPolicy        *string                `protobuf:"bytes,13,opt,name=default_caching_policy,json=defaultCachingPolicy"`
	xxx_hidden_AllowedCachingPolicies      []string               `protobuf:"bytes,14,rep,name=allowed_caching_policies,json=allowedCachingPolicies"`
	XXX_raceDetectHookData                 protoimpl.RaceDetectHookData
	XXX_presence                           [1]uint32
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
...
func (x *TableProfileDescription) GetDefaultStoragePolicy() string {
	if x != nil {
		if x.xxx_hidden_DefaultStoragePolicy != nil {
...
func (x *TableProfileDescription) GetDefaultCompactionPolicy() string {
	if x != nil {
		if x.xxx_hidden_DefaultCompactionPolicy != nil {
...
func (x *TableProfileDescription) GetDefaultPartitioningPolicy() string {
	if x != nil {
		if x.xxx_hidden_DefaultPartitioningPolicy != nil {
...
func (x *TableProfileDescription) GetDefaultExecutionPolicy() string {
	if x != nil {
		if x.xxx_hidden_DefaultExecutionPolicy != nil {
...
func (x *TableProfileDescription) GetDefaultReplicationPolicy() string {
	if x != nil {
		if x.xxx_hidden_DefaultReplicationPolicy != nil {
...
func (x *TableProfileDescription) GetDefaultCachingPolicy() string {
	if x != nil {
		if x.xxx_hidden_DefaultCachingPolicy != nil {
...
func (b0 TableProfileDescription_builder) Build() *TableProfileDescription {
	...
	if b.DefaultCompactionPolicy != nil {
	...
	if b.DefaultPartitioningPolicy != nil {
	...
	if b.DefaultExecutionPolicy != nil {
	...
	if b.DefaultReplicationPolicy != nil {
...
type DescribeTableOptionsResult struct {
	state                                protoimpl.MessageState            `protogen:"opaque.v1"`
	xxx_hidden_TableProfilePresets       *[]*TableProfileDescription       `protobuf:"bytes,1,rep,name=table_profile_presets,json=tableProfilePresets"`
	xxx_hidden_StoragePolicyPresets      *[]*StoragePolicyDescription      `protobuf:"bytes,2,rep,name=storage_policy_presets,json=storagePolicyPresets"`
	xxx_hidden_CompactionPolicyPresets   *[]*CompactionPolicyDescription   `protobuf:"bytes,3,rep,name=compaction_policy_presets,json=compactionPolicyPresets"`
	xxx_hidden_PartitioningPolicyPresets *[]*PartitioningPolicyDescription `protobuf:"bytes,4,rep,name=partitioning_policy_presets,json=partitioningPolicyPresets"`
	xxx_hidden_ExecutionPolicyPresets    *[]*ExecutionPolicyDescription    `protobuf:"bytes,5,rep,name=execution_policy_presets,json=executionPolicyPresets"`
	xxx_hidden_ReplicationPolicyPresets  *[]*ReplicationPolicyDescription  `protobuf:"bytes,6,rep,name=replication_policy_presets,json=replicationPolicyPresets"`
	xxx_hidden_CachingPolicyPresets      *[]*CachingPolicyDescription      `protobuf:"bytes,7,rep,name=caching_policy_presets,json=cachingPolicyPresets"`
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
}
...
type ReadTableRequest struct {
	...
	xxx_hidden_SessionId                   *string                `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_Path                        *string                `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_KeyRange                    *KeyRange              `protobuf:"bytes,3,opt,name=key_range,json=keyRange"`
	xxx_hidden_Columns                     []string               `protobuf:"bytes,4,rep,name=columns"`
	xxx_hidden_Ordered                     bool                   `protobuf:"varint,5,opt,name=ordered"`
	xxx_hidden_RowLimit                    uint64                 `protobuf:"varint,6,opt,name=row_limit,json=rowLimit"`
	xxx_hidden_UseSnapshot                 Ydb.FeatureFlag_Status `protobuf:"varint,7,opt,name=use_snapshot,json=useSnapshot,enum=Ydb.FeatureFlag_Status"`
	xxx_hidden_BatchLimitBytes             uint64                 `protobuf:"varint,8,opt,name=batch_limit_bytes,json=batchLimitBytes"`
	xxx_hidden_BatchLimitRows              uint64                 `protobuf:"varint,9,opt,name=batch_limit_rows,json=batchLimitRows"`
	xxx_hidden_ReturnNotNullDataAsOptional Ydb.FeatureFlag_Status `protobuf:"varint,10,opt,name=return_not_null_data_as_optional,json=returnNotNullDataAsOptional,enum=Ydb.FeatureFlag_Status"`
	XXX_raceDetectHookData                 protoimpl.RaceDetectHookData
	XXX_presence                           [1]uint32
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
...
func (x *ReadTableRequest) ClearOrdered() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_Ordered = false
}

func (x *ReadTableRequest) ClearRowLimit() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_RowLimit = 0
}

func (x *ReadTableRequest) ClearUseSnapshot() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 6)
	x.xxx_hidden_UseSnapshot = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}

func (x *ReadTableRequest) ClearBatchLimitBytes() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 7)
	x.xxx_hidden_BatchLimitBytes = 0
}

func (x *ReadTableRequest) ClearBatchLimitRows() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 8)
	x.xxx_hidden_BatchLimitRows = 0
}

func (x *ReadTableRequest) ClearReturnNotNullDataAsOptional() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 9)
	x.xxx_hidden_ReturnNotNullDataAsOptional = Ydb.FeatureFlag_STATUS_UNSPECIFIED
}
...
type ReadTableResponse struct {
	...
	xxx_hidden_Snapshot    *Ydb.VirtualTimestamp      `protobuf:"bytes,4,opt,name=snapshot"`
	xxx_hidden_Result      *ReadTableResult           `protobuf:"bytes,3,opt,name=result"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ReadTableResult struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ResultSet *Ydb.ResultSet         `protobuf:"bytes,1,opt,name=result_set,json=resultSet"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type ReadRowsRequest struct {
	...
	xxx_hidden_SessionId   *string                `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_Path        *string                `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_Keys        *Ydb.TypedValue        `protobuf:"bytes,3,opt,name=keys"`
	xxx_hidden_Columns     []string               `protobuf:"bytes,4,rep,name=columns"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
...
type ReadRowsResponse struct {
	...
	xxx_hidden_Status      Ydb.StatusIds_StatusCode   `protobuf:"varint,1,opt,name=status,enum=Ydb.StatusIds_StatusCode"`
	xxx_hidden_Issues      *[]*Ydb_Issue.IssueMessage `protobuf:"bytes,2,rep,name=issues"`
	xxx_hidden_ResultSet   *Ydb.ResultSet             `protobuf:"bytes,3,opt,name=result_set,json=resultSet"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type BulkUpsertRequest struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_Table           *string                         `protobuf:"bytes,1,opt,name=table"`
	xxx_hidden_Rows            *Ydb.TypedValue                 `protobuf:"bytes,2,opt,name=rows"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,3,opt,name=operation_params,json=operationParams"`
	xxx_hidden_DataFormat      isBulkUpsertRequest_DataFormat  `protobuf_oneof:"data_format"`
	xxx_hidden_Data            []byte                          `protobuf:"bytes,1000,opt,name=data"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type ExecuteScanQueryRequest struct {
	...
	xxx_hidden_Query                  *Query                       `protobuf:"bytes,3,opt,name=query"`
	xxx_hidden_Parameters             map[string]*Ydb.TypedValue   `protobuf:"bytes,4,rep,name=parameters" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Mode                   ExecuteScanQueryRequest_Mode `protobuf:"varint,6,opt,name=mode,enum=Ydb.Table.ExecuteScanQueryRequest_Mode"`
	xxx_hidden_CollectStats           QueryStatsCollection_Mode    `protobuf:"varint,8,opt,name=collect_stats,json=collectStats,enum=Ydb.Table.QueryStatsCollection_Mode"`
	xxx_hidden_CollectFullDiagnostics bool                         `protobuf:"varint,9,opt,name=collect_full_diagnostics,json=collectFullDiagnostics"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
func (x *ExecuteScanQueryRequest) ClearMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_Mode = ExecuteScanQueryRequest_MODE_UNSPECIFIED
}
...
type ExecuteScanQueryPartialResponse struct {
	...
	xxx_hidden_Status      Ydb.StatusIds_StatusCode       `protobuf:"varint,1,opt,name=status,enum=Ydb.StatusIds_StatusCode"`
	xxx_hidden_Issues      *[]*Ydb_Issue.IssueMessage     `protobuf:"bytes,2,rep,name=issues"`
	xxx_hidden_Result      *ExecuteScanQueryPartialResult `protobuf:"bytes,3,opt,name=result"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ExecuteScanQueryPartialResult struct {
	state                           protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_ResultSet            *Ydb.ResultSet             `protobuf:"bytes,1,opt,name=result_set,json=resultSet"`
	xxx_hidden_QueryStats           *Ydb_TableStats.QueryStats `protobuf:"bytes,6,opt,name=query_stats,json=queryStats"`
	xxx_hidden_QueryFullDiagnostics *string                    `protobuf:"bytes,7,opt,name=query_full_diagnostics,json=queryFullDiagnostics"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
type SequenceDescription_SetVal struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_NextValue   int64                  `protobuf:"zigzag64,1,opt,name=next_value,json=nextValue"`
	xxx_hidden_NextUsed    bool                   `protobuf:"varint,2,opt,name=next_used,json=nextUsed"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
