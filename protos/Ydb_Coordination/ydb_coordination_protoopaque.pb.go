...
type Config struct {
	...
	xxx_hidden_SelfCheckPeriodMillis    uint32                  `protobuf:"varint,2,opt,name=self_check_period_millis,json=selfCheckPeriodMillis"`
	xxx_hidden_SessionGracePeriodMillis uint32                  `protobuf:"varint,3,opt,name=session_grace_period_millis,json=sessionGracePeriodMillis"`
	xxx_hidden_ReadConsistencyMode      ConsistencyMode         `protobuf:"varint,4,opt,name=read_consistency_mode,json=readConsistencyMode,enum=Ydb.Coordination.ConsistencyMode"`
	xxx_hidden_AttachConsistencyMode    ConsistencyMode         `protobuf:"varint,5,opt,name=attach_consistency_mode,json=attachConsistencyMode,enum=Ydb.Coordination.ConsistencyMode"`
	xxx_hidden_RateLimiterCountersMode  RateLimiterCountersMode `protobuf:"varint,6,opt,name=rate_limiter_counters_mode,json=rateLimiterCountersMode,enum=Ydb.Coordination.RateLimiterCountersMode"`
...
func (x *Config) ClearSelfCheckPeriodMillis() {
	...
	x.xxx_hidden_SelfCheckPeriodMillis = 0
}

func (x *Config) ClearSessionGracePeriodMillis() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_SessionGracePeriodMillis = 0
}

func (x *Config) ClearReadConsistencyMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_ReadConsistencyMode = ConsistencyMode_CONSISTENCY_MODE_UNSET
}

func (x *Config) ClearAttachConsistencyMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_AttachConsistencyMode = ConsistencyMode_CONSISTENCY_MODE_UNSET
}

func (x *Config) ClearRateLimiterCountersMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_RateLimiterCountersMode = RateLimiterCountersMode_RATE_LIMITER_COUNTERS_MODE_UNSET
}
...
type SessionDescription struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SessionId     uint64                 `protobuf:"varint,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_TimeoutMillis uint64                 `protobuf:"varint,2,opt,name=timeout_millis,json=timeoutMillis"`
	xxx_hidden_Description   *string                `protobuf:"bytes,3,opt,name=description"`
	xxx_hidden_Attached      bool                   `protobuf:"varint,4,opt,name=attached"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
type SemaphoreSession struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_OrderId       uint64                 `protobuf:"varint,5,opt,name=order_id,json=orderId"`
	xxx_hidden_SessionId     uint64                 `protobuf:"varint,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_TimeoutMillis uint64                 `protobuf:"varint,2,opt,name=timeout_millis,json=timeoutMillis"`
...
type SemaphoreDescription struct {
	...
	xxx_hidden_Count       uint64                 `protobuf:"varint,7,opt,name=count"`
	xxx_hidden_Limit       uint64                 `protobuf:"varint,3,opt,name=limit"`
	xxx_hidden_Ephemeral   bool                   `protobuf:"varint,4,opt,name=ephemeral"`
	xxx_hidden_Owners      *[]*SemaphoreSession   `protobuf:"bytes,5,rep,name=owners"`
	xxx_hidden_Waiters     *[]*SemaphoreSession   `protobuf:"bytes,6,rep,name=waiters"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type CreateNodeRequest struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_Path            *string                         `protobuf:"bytes,1,opt,name=path"`
	xxx_hidden_Config          *Config                         `protobuf:"bytes,2,opt,name=config"`
...
type SessionRequest_PingPong struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Opaque      uint64                 `protobuf:"varint,1,opt,name=opaque"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type SessionRequest_SessionStart struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Path          *string                `protobuf:"bytes,1,opt,name=path"`
	xxx_hidden_SessionId     uint64                 `protobuf:"varint,2,opt,name=session_id,json=sessionId"`
	xxx_hidden_TimeoutMillis uint64                 `protobuf:"varint,3,opt,name=timeout_millis,json=timeoutMillis"`
	xxx_hidden_Description   *string                `protobuf:"bytes,4,opt,name=description"`
	xxx_hidden_SeqNo         uint64                 `protobuf:"varint,5,opt,name=seq_no,json=seqNo"`
	xxx_hidden_ProtectionKey []byte                 `protobuf:"bytes,6,opt,name=protection_key,json=protectionKey"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *SessionRequest_SessionStart) ClearProtectionKey() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_ProtectionKey = nil
}
...
type SessionRequest_AcquireSemaphore struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ReqId         uint64                 `protobuf:"varint,1,opt,name=req_id,json=reqId"`
	xxx_hidden_Name          *string                `protobuf:"bytes,2,opt,name=name"`
	xxx_hidden_TimeoutMillis uint64                 `protobuf:"varint,3,opt,name=timeout_millis,json=timeoutMillis"`
	xxx_hidden_Count         uint64                 `protobuf:"varint,4,opt,name=count"`
	xxx_hidden_Data          []byte                 `protobuf:"bytes,5,opt,name=data"`
	xxx_hidden_Ephemeral     bool                   `protobuf:"varint,6,opt,name=ephemeral"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
type SessionRequest_DescribeSemaphore struct {
	...
	xxx_hidden_ReqId          uint64                 `protobuf:"varint,1,opt,name=req_id,json=reqId"`
	xxx_hidden_Name           *string                `protobuf:"bytes,2,opt,name=name"`
	xxx_hidden_IncludeOwners  bool                   `protobuf:"varint,3,opt,name=include_owners,json=includeOwners"`
	xxx_hidden_IncludeWaiters bool                   `protobuf:"varint,4,opt,name=include_waiters,json=includeWaiters"`
	xxx_hidden_WatchData      bool                   `protobuf:"varint,5,opt,name=watch_data,json=watchData"`
	xxx_hidden_WatchOwners    bool                   `protobuf:"varint,6,opt,name=watch_owners,json=watchOwners"`
	XXX_raceDetectHookData    protoimpl.RaceDetectHookData
	XXX_presence              [1]uint32
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
...
func (b0 SessionRequest_DescribeSemaphore_builder) Build() *SessionRequest_DescribeSemaphore {
	...
	if b.IncludeOwners != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 6)
		x.xxx_hidden_IncludeOwners = *b.IncludeOwners
	}
	if b.IncludeWaiters != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 3, 6)
...
type SessionResponse_AcquireSemaphoreResult struct {
	...
	xxx_hidden_Issues      *[]*Ydb_Issue.IssueMessage `protobuf:"bytes,3,rep,name=issues"`
	xxx_hidden_Acquired    bool                       `protobuf:"varint,4,opt,name=acquired"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type SessionResponse_ReleaseSemaphoreResult struct {
	...
	xxx_hidden_Status      Ydb.StatusIds_StatusCode   `protobuf:"varint,2,opt,name=status,enum=Ydb.StatusIds_StatusCode"`
	xxx_hidden_Issues      *[]*Ydb_Issue.IssueMessage `protobuf:"bytes,3,rep,name=issues"`
	xxx_hidden_Released    bool                       `protobuf:"varint,4,opt,name=released"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type SessionResponse_DescribeSemaphoreResult struct {
	...
	xxx_hidden_Status               Ydb.StatusIds_StatusCode   `protobuf:"varint,2,opt,name=status,enum=Ydb.StatusIds_StatusCode"`
	xxx_hidden_Issues               *[]*Ydb_Issue.IssueMessage `protobuf:"bytes,3,rep,name=issues"`
	xxx_hidden_SemaphoreDescription *SemaphoreDescription      `protobuf:"bytes,4,opt,name=semaphore_description,json=semaphoreDescription"`
	xxx_hidden_WatchAdded           bool                       `protobuf:"varint,5,opt,name=watch_added,json=watchAdded"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
type SessionResponse_DescribeSemaphoreChanged struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ReqId         uint64                 `protobuf:"varint,1,opt,name=req_id,json=reqId"`
	xxx_hidden_DataChanged   bool                   `protobuf:"varint,2,opt,name=data_changed,json=dataChanged"`
	xxx_hidden_OwnersChanged bool                   `protobuf:"varint,3,opt,name=owners_changed,json=ownersChanged"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (b0 SessionResponse_DescribeSemaphoreChanged_builder) Build() *SessionResponse_DescribeSemaphoreChanged {
	...
	if b.DataChanged != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 1, 3)
		x.xxx_hidden_DataChanged = *b.DataChanged
	}
	if b.OwnersChanged != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 3)
