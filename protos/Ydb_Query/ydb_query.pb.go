...
func file_protos_ydb_query_proto_init() {
	...
	file_protos_ydb_query_proto_msgTypes[13].OneofWrappers = []interface{}{
	...
	file_protos_ydb_query_proto_msgTypes[14].OneofWrappers = []interface{}{
		(*TransactionControl_TxId)(nil),
		(*TransactionControl_BeginTx)(nil),
	}
	file_protos_ydb_query_proto_msgTypes[23].OneofWrappers = []interface{}{
