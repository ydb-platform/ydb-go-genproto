...
func (x *ExportItemProgress) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *ExportItemProgress) GetEndTime() *timestamp.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
var file_protos_ydb_export_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x4f, 0x0a, 0x0f, 0x74, 0x65, 0x63, 0x68, 0x2e, 0x79, 0x64, 0x62,
