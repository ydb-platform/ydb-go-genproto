...
type ExportToYtSettings struct {
	...
	xxx_hidden_Items           *[]*ExportToYtSettings_Item `protobuf:"bytes,4,rep,name=items"`
	xxx_hidden_Description     *string                     `protobuf:"bytes,5,opt,name=description"`
	xxx_hidden_NumberOfRetries uint32                      `protobuf:"varint,6,opt,name=number_of_retries,json=numberOfRetries"`
	xxx_hidden_UseTypeV3       bool                        `protobuf:"varint,7,opt,name=use_type_v3,json=useTypeV3"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type ExportToYtMetadata struct {
	state                    protoimpl.MessageState  `protogen:"opaque.v1"`
	xxx_hidden_Settings      *ExportToYtSettings     `protobuf:"bytes,1,opt,name=settings"`
	xxx_hidden_Progress      ExportProgress_Progress `protobuf:"varint,2,opt,name=progress,enum=Ydb.Export.ExportProgress_Progress"`
	xxx_hidden_ItemsProgress *[]*ExportItemProgress  `protobuf:"bytes,3,rep,name=items_progress,json=itemsProgress"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *ExportToYtMetadata) ClearProgress() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_Progress = ExportProgress_PROGRESS_UNSPECIFIED
}
...
type ExportToYtRequest struct {
	...
	xxx_hidden_Settings        *ExportToYtSettings             `protobuf:"bytes,2,opt,name=settings"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type ExportToS3Settings struct {
	...
	xxx_hidden_Scheme                   ExportToS3Settings_Scheme       `protobuf:"varint,2,opt,name=scheme,enum=Ydb.Export.ExportToS3Settings_Scheme"`
	...
	xxx_hidden_Items                    *[]*ExportToS3Settings_Item     `protobuf:"bytes,6,rep,name=items"`
	...
	xxx_hidden_StorageClass             ExportToS3Settings_StorageClass `protobuf:"varint,9,opt,name=storage_class,json=storageClass,enum=Ydb.Export.ExportToS3Settings_StorageClass"`
	xxx_hidden_Compression              *string                         `protobuf:"bytes,10,opt,name=compression"`
	xxx_hidden_Region                   *string                         `protobuf:"bytes,11,opt,name=region"`
	xxx_hidden_DisableVirtualAddressing bool                            `protobuf:"varint,12,opt,name=disable_virtual_addressing,json=disableVirtualAddressing"`
	XXX_raceDetectHookData              protoimpl.RaceDetectHookData
	XXX_presence                        [1]uint32
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
...
func (x *ExportToS3Settings) ClearScheme() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_Scheme = ExportToS3Settings_UNSPECIFIED
}
...
func (x *ExportToS3Settings) ClearStorageClass() {
	...
	x.xxx_hidden_StorageClass = ExportToS3Settings_STORAGE_CLASS_UNSPECIFIED
}
...
type ExportToS3Metadata struct {
	state                    protoimpl.MessageState  `protogen:"opaque.v1"`
	xxx_hidden_Settings      *ExportToS3Settings     `protobuf:"bytes,1,opt,name=settings"`
	xxx_hidden_Progress      ExportProgress_Progress `protobuf:"varint,2,opt,name=progress,enum=Ydb.Export.ExportProgress_Progress"`
	xxx_hidden_ItemsProgress *[]*ExportItemProgress  `protobuf:"bytes,3,rep,name=items_progress,json=itemsProgress"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
...
type ExportToS3Request struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_Settings        *ExportToS3Settings             `protobuf:"bytes,2,opt,name=settings"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type ExportToS3Settings_Item struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SourcePath        *string                `protobuf:"bytes,1,opt,name=source_path,json=sourcePath"`
	xxx_hidden_DestinationPrefix *string                `protobuf:"bytes,2,opt,name=destination_prefix,json=destinationPrefix"`
	XXX_raceDetectHookData       protoimpl.RaceDetectHookData
	XXX_presence                 [1]uint32
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
...
func (x *ExportToS3Settings_Item) GetDestinationPrefix() string {
	if x != nil {
		if x.xxx_hidden_DestinationPrefix != nil {
...
func (x *ExportToS3Settings_Item) ClearDestinationPrefix() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_DestinationPrefix = nil
}
