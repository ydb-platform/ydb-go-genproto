...
type ResultSet struct {
	...
	Format ResultSet_Format `protobuf:"varint,4,opt,name=format,proto3,enum=Ydb.ResultSet_Format" json:"format,omitempty"`
	// Metadata of the result set rows, only used for FORMAT_ARROW
	ArrowFormatMeta *Ydb_Formats.ArrowFormatMeta `protobuf:"bytes,5,opt,name=arrow_format_meta,json=arrowFormatMeta,proto3" json:"arrow_format_meta,omitempty"`
...
func (x *ResultSet) HasArrowFormatMeta() bool {
	...
	return x.ArrowFormatMeta != nil
}

func (x *ResultSet) ClearArrowFormatMeta() {
	x.ArrowFormatMeta = nil
}
...
func (b0 ResultSet_builder) Build() *ResultSet {
	...
	x.Format = b.Format
	x.ArrowFormatMeta = b.ArrowFormatMeta
	x.Data = b.Data
	return m0
}
