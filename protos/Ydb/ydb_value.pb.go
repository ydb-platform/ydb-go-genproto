...
type ResultSet_Type int32

const (
	ResultSet_UNSPECIFIED ResultSet_Type = 0
	ResultSet_MESSAGE     ResultSet_Type = 10
	ResultSet_ARROW       ResultSet_Type = 20
)

// Enum value maps for ResultSet_Type.
var (
	ResultSet_Type_name = map[int32]string{
		0:  "UNSPECIFIED",
		10: "MESSAGE",
		20: "ARROW",
	}
	ResultSet_Type_value = map[string]int32{
		"UNSPECIFIED": 0,
		"MESSAGE":     10,
		"ARROW":       20,
	}
...
func (x ResultSet_Type) Enum() *ResultSet_Type {
	p := new(ResultSet_Type)
	*p = x
	return p
}

func (x ResultSet_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ResultSet_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_ydb_value_proto_enumTypes[1].Descriptor()
}

func (ResultSet_Type) Type() protoreflect.EnumType {
	return &file_protos_ydb_value_proto_enumTypes[1]
}

func (x ResultSet_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ResultSet_Type.Descriptor instead.
func (ResultSet_Type) EnumDescriptor() ([]byte, []int) {
	return file_protos_ydb_value_proto_rawDescGZIP(), []int{15, 0}
}
...
type ResultSet struct {
	...
	Type ResultSet_Type `protobuf:"varint,4,opt,name=type,proto3,enum=Ydb.ResultSet_Type" json:"type,omitempty"`
	// Settings for an arrow type of result
	ArrowBatchSettings *Ydb_Formats.ArrowBatchSettings `protobuf:"bytes,5,opt,name=arrow_batch_settings,json=arrowBatchSettings,proto3" json:"arrow_batch_settings,omitempty"`
...
func (x *ResultSet) GetType() ResultSet_Type {
	if x != nil {
		return x.Type
	}
	return ResultSet_UNSPECIFIED
}

func (x *ResultSet) GetArrowBatchSettings() *Ydb_Formats.ArrowBatchSettings {
	if x != nil {
...
var file_protos_ydb_value_proto_rawDesc = []byte{
	...
	0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xb2, 0x02, 0x0a, 0x09, 0x52,
	...
	0x28, 0x08, 0x52, 0x09, 0x74, 0x72, 0x75, 0x6e, 0x63, 0x61, 0x74, 0x65, 0x64, 0x12, 0x27, 0x0a,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x59, 0x64,
	0x62, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x53, 0x65, 0x74, 0x2e, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x51, 0x0a, 0x14, 0x61, 0x72, 0x72, 0x6f, 0x77, 0x5f,
	...
	,
	...
	0x64, 0x62, 0xf8, 0x01, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_protos_ydb_value_proto_goTypes = []interface{}{
	...
	(ResultSet_Type)(0),                    // 1: Ydb.ResultSet.Type
	...
	(*Ydb_Formats.ArrowBatchSettings)(nil), // 19: Ydb.Formats.ArrowBatchSettings
}
var file_protos_ydb_value_proto_depIdxs = []int32{
	...
	1,  // 35: Ydb.ResultSet.type:type_name -> Ydb.ResultSet.Type
	19, // 36: Ydb.ResultSet.arrow_batch_settings:type_name -> Ydb.Formats.ArrowBatchSettings
