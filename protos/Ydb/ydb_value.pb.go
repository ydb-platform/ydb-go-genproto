...
func (x *Type) GetVoidType() _struct.NullValue {
...
func (x *Type) GetNullType() _struct.NullValue {
...
func (x *Type) GetEmptyListType() _struct.NullValue {
...
func (x *Type) GetEmptyDictType() _struct.NullValue {
...
type Type_NullType struct {
	NullType _struct.NullValue `protobuf:"varint,202,opt,name=null_type,json=nullType,proto3,enum=google.protobuf.NullValue,oneof"`
}

type Type_EmptyListType struct {
	EmptyListType _struct.NullValue `protobuf:"varint,203,opt,name=empty_list_type,json=emptyListType,proto3,enum=google.protobuf.NullValue,oneof"`
}

type Type_EmptyDictType struct {
	EmptyDictType _struct.NullValue `protobuf:"varint,204,opt,name=empty_dict_type,json=emptyDictType,proto3,enum=google.protobuf.NullValue,oneof"`
}
...
func (x *Value) GetNullFlagValue() _struct.NullValue {
...
type Value_NullFlagValue struct {
	NullFlagValue _struct.NullValue `protobuf:"varint,10,opt,name=null_flag_value,json=nullFlagValue,proto3,enum=google.protobuf.NullValue,oneof"` // Set if current TValue is terminal Null
}
...
var file_protos_ydb_value_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x42, 0x4e, 0x0a, 0x08, 0x74, 0x65, 0x63, 0x68, 0x2e, 0x79, 0x64, 0x62, 0x42, 0x0b,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x5a, 0x32, 0x67, 0x69, 0x74,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x59, 0x64, 0x62, 0xf8,
...
var file_protos_ydb_value_proto_goTypes = []interface{}{
	...
	(_struct.NullValue)(0),    // 17: google.protobuf.NullValue
}
