...
func (x *OperationParams) GetOperationTimeout() *duration.Duration {
	if x != nil {
...
func (x *OperationParams) GetCancelAfter() *duration.Duration {
	if x != nil {
...
type Operation struct {
	...
	Metadata *any1.Any `protobuf:"bytes,6,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (x *Operation) GetResult() *any1.Any {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_protos_ydb_operation_proto_rawDesc = []byte{
	...
	0x42, 0x5d, 0x0a, 0x08, 0x74, 0x65, 0x63, 0x68, 0x2e, 0x79, 0x64, 0x62, 0x42, 0x0f, 0x4f, 0x70,
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x5a, 0x3d, 0x67,
	...
	0x62, 0x5f, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0xf8, 0x01, 0x01, 0x62,
