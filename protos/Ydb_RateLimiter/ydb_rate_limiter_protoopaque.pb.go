...
type HierarchicalDrrSettings struct {
	...
	xxx_hidden_MaxUnitsPerSecond       float64                `protobuf:"fixed64,1,opt,name=max_units_per_second,json=maxUnitsPerSecond"`
	xxx_hidden_MaxBurstSizeCoefficient float64                `protobuf:"fixed64,2,opt,name=max_burst_size_coefficient,json=maxBurstSizeCoefficient"`
	xxx_hidden_PrefetchCoefficient     float64                `protobuf:"fixed64,3,opt,name=prefetch_coefficient,json=prefetchCoefficient"`
	xxx_hidden_PrefetchWatermark       float64                `protobuf:"fixed64,4,opt,name=prefetch_watermark,json=prefetchWatermark"`
...
type Resource struct {
	state                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ResourcePath *string                `protobuf:"bytes,1,opt,name=resource_path,json=resourcePath"`
...
func (x *Resource) GetResourcePath() string {
	if x != nil {
		if x.xxx_hidden_ResourcePath != nil {
...
type CreateResourceRequest struct {
	...
	xxx_hidden_CoordinationNodePath *string                         `protobuf:"bytes,2,opt,name=coordination_node_path,json=coordinationNodePath"`
	xxx_hidden_Resource             *Resource                       `protobuf:"bytes,3,opt,name=resource"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
func (x *CreateResourceRequest) GetCoordinationNodePath() string {
	if x != nil {
		if x.xxx_hidden_CoordinationNodePath != nil {
...
func (x *CreateResourceRequest) ClearCoordinationNodePath() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_CoordinationNodePath = nil
}
...
type DropResourceRequest struct {
	...
	xxx_hidden_OperationParams      *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_CoordinationNodePath *string                         `protobuf:"bytes,2,opt,name=coordination_node_path,json=coordinationNodePath"`
	xxx_hidden_ResourcePath         *string                         `protobuf:"bytes,3,opt,name=resource_path,json=resourcePath"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
type ListResourcesResult struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ResourcePaths []string               `protobuf:"bytes,1,rep,name=resource_paths,json=resourcePaths"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
