...
type SupportedCodecs struct {
	...
	xxx_hidden_Codecs []int32                `protobuf:"varint,1,rep,packed,name=codecs"`
...
type PartitionWithGeneration struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionId int64                  `protobuf:"varint,1,opt,name=partition_id,json=partitionId"`
...
type UpdateOffsetsInTransactionRequest struct {
	...
	xxx_hidden_Tx              *TransactionIdentity                               `protobuf:"bytes,2,opt,name=tx"`
	xxx_hidden_Topics          *[]*UpdateOffsetsInTransactionRequest_TopicOffsets `protobuf:"bytes,3,rep,name=topics"`
	xxx_hidden_Consumer        *string                                            `protobuf:"bytes,4,opt,name=consumer"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type CommitOffsetRequest struct {
	...
	xxx_hidden_PartitionId     int64                           `protobuf:"varint,3,opt,name=partition_id,json=partitionId"`
	xxx_hidden_Consumer        *string                         `protobuf:"bytes,4,opt,name=consumer"`
...
type MultipleWindowsStat struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PerMinute   int64                  `protobuf:"varint,1,opt,name=per_minute,json=perMinute"`
	xxx_hidden_PerHour     int64                  `protobuf:"varint,2,opt,name=per_hour,json=perHour"`
	xxx_hidden_PerDay      int64                  `protobuf:"varint,3,opt,name=per_day,json=perDay"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type Consumer struct {
	...
	xxx_hidden_Important       bool                    `protobuf:"varint,2,opt,name=important"`
	xxx_hidden_ReadFrom        *timestamppb.Timestamp  `protobuf:"bytes,3,opt,name=read_from,json=readFrom"`
	xxx_hidden_SupportedCodecs *SupportedCodecs        `protobuf:"bytes,5,opt,name=supported_codecs,json=supportedCodecs"`
	...
	xxx_hidden_ConsumerStats   *Consumer_ConsumerStats `protobuf:"bytes,7,opt,name=consumer_stats,json=consumerStats"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type AlterConsumer struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Name               *string                `protobuf:"bytes,1,opt,name=name"`
	xxx_hidden_SetImportant       bool                   `protobuf:"varint,2,opt,name=set_important,json=setImportant"`
	xxx_hidden_SetReadFrom        *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=set_read_from,json=setReadFrom"`
	xxx_hidden_SetSupportedCodecs *SupportedCodecs       `protobuf:"bytes,5,opt,name=set_supported_codecs,json=setSupportedCodecs"`
	xxx_hidden_AlterAttributes    map[string]string      `protobuf:"bytes,6,rep,name=alter_attributes,json=alterAttributes" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type PartitioningSettings struct {
	state                               protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_MinActivePartitions      int64                     `protobuf:"varint,1,opt,name=min_active_partitions,json=minActivePartitions"`
	xxx_hidden_MaxActivePartitions      int64                     `protobuf:"varint,3,opt,name=max_active_partitions,json=maxActivePartitions"`
	xxx_hidden_PartitionCountLimit      int64                     `protobuf:"varint,2,opt,name=partition_count_limit,json=partitionCountLimit"`
	xxx_hidden_AutoPartitioningSettings *AutoPartitioningSettings `protobuf:"bytes,4,opt,name=auto_partitioning_settings,json=autoPartitioningSettings"`
	XXX_raceDetectHookData              protoimpl.RaceDetectHookData
	XXX_presence                        [1]uint32
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
...
type AutoPartitioningSettings struct {
	state                          protoimpl.MessageState              `protogen:"opaque.v1"`
	xxx_hidden_Strategy            AutoPartitioningStrategy            `protobuf:"varint,1,opt,name=strategy,enum=Ydb.Topic.AutoPartitioningStrategy"`
	xxx_hidden_PartitionWriteSpeed *AutoPartitioningWriteSpeedStrategy `protobuf:"bytes,2,opt,name=partition_write_speed,json=partitionWriteSpeed"`
	XXX_raceDetectHookData         protoimpl.RaceDetectHookData
	XXX_presence                   [1]uint32
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
...
func (x *AutoPartitioningSettings) ClearStrategy() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_Strategy = AutoPartitioningStrategy_AUTO_PARTITIONING_STRATEGY_UNSPECIFIED
}
...
type AutoPartitioningWriteSpeedStrategy struct {
	state                             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_StabilizationWindow    *durationpb.Duration   `protobuf:"bytes,1,opt,name=stabilization_window,json=stabilizationWindow"`
	xxx_hidden_UpUtilizationPercent   int32                  `protobuf:"varint,2,opt,name=up_utilization_percent,json=upUtilizationPercent"`
	xxx_hidden_DownUtilizationPercent int32                  `protobuf:"varint,3,opt,name=down_utilization_percent,json=downUtilizationPercent"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
func (x *AutoPartitioningWriteSpeedStrategy) ClearUpUtilizationPercent() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_UpUtilizationPercent = 0
}

func (x *AutoPartitioningWriteSpeedStrategy) ClearDownUtilizationPercent() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_DownUtilizationPercent = 0
}
...
func (b0 AutoPartitioningWriteSpeedStrategy_builder) Build() *AutoPartitioningWriteSpeedStrategy {
	...
	if b.UpUtilizationPercent != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 1, 3)
		x.xxx_hidden_UpUtilizationPercent = *b.UpUtilizationPercent
	}
	if b.DownUtilizationPercent != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 2, 3)
...
type AlterPartitioningSettings struct {
	state                                    protoimpl.MessageState         `protogen:"opaque.v1"`
	xxx_hidden_SetMinActivePartitions        int64                          `protobuf:"varint,1,opt,name=set_min_active_partitions,json=setMinActivePartitions"`
	xxx_hidden_SetMaxActivePartitions        int64                          `protobuf:"varint,3,opt,name=set_max_active_partitions,json=setMaxActivePartitions"`
	xxx_hidden_SetPartitionCountLimit        int64                          `protobuf:"varint,2,opt,name=set_partition_count_limit,json=setPartitionCountLimit"`
	xxx_hidden_AlterAutoPartitioningSettings *AlterAutoPartitioningSettings `protobuf:"bytes,4,opt,name=alter_auto_partitioning_settings,json=alterAutoPartitioningSettings"`
	XXX_raceDetectHookData                   protoimpl.RaceDetectHookData
	XXX_presence                             [1]uint32
	unknownFields                            protoimpl.UnknownFields
	sizeCache                                protoimpl.SizeCache
...
type AlterAutoPartitioningSettings struct {
	state                             protoimpl.MessageState                   `protogen:"opaque.v1"`
	xxx_hidden_SetStrategy            AutoPartitioningStrategy                 `protobuf:"varint,1,opt,name=set_strategy,json=setStrategy,enum=Ydb.Topic.AutoPartitioningStrategy"`
	xxx_hidden_SetPartitionWriteSpeed *AlterAutoPartitioningWriteSpeedStrategy `protobuf:"bytes,2,opt,name=set_partition_write_speed,json=setPartitionWriteSpeed"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
type AlterAutoPartitioningWriteSpeedStrategy struct {
	state                                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_SetStabilizationWindow    *durationpb.Duration   `protobuf:"bytes,1,opt,name=set_stabilization_window,json=setStabilizationWindow"`
	xxx_hidden_SetUpUtilizationPercent   int32                  `protobuf:"varint,2,opt,name=set_up_utilization_percent,json=setUpUtilizationPercent"`
	xxx_hidden_SetDownUtilizationPercent int32                  `protobuf:"varint,3,opt,name=set_down_utilization_percent,json=setDownUtilizationPercent"`
	XXX_raceDetectHookData               protoimpl.RaceDetectHookData
	XXX_presence                         [1]uint32
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
...
type CreateTopicRequest struct {
	...
	xxx_hidden_OperationParams                   *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_Path                              *string                         `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_PartitioningSettings              *PartitioningSettings           `protobuf:"bytes,3,opt,name=partitioning_settings,json=partitioningSettings"`
	xxx_hidden_RetentionPeriod                   *durationpb.Duration            `protobuf:"bytes,4,opt,name=retention_period,json=retentionPeriod"`
	xxx_hidden_RetentionStorageMb                int64                           `protobuf:"varint,5,opt,name=retention_storage_mb,json=retentionStorageMb"`
	xxx_hidden_SupportedCodecs                   *SupportedCodecs                `protobuf:"bytes,7,opt,name=supported_codecs,json=supportedCodecs"`
	xxx_hidden_PartitionWriteSpeedBytesPerSecond int64                           `protobuf:"varint,8,opt,name=partition_write_speed_bytes_per_second,json=partitionWriteSpeedBytesPerSecond"`
	xxx_hidden_PartitionWriteBurstBytes          int64                           `protobuf:"varint,9,opt,name=partition_write_burst_bytes,json=partitionWriteBurstBytes"`
	...
	xxx_hidden_Consumers                         *[]*Consumer                    `protobuf:"bytes,11,rep,name=consumers"`
	xxx_hidden_MeteringMode                      MeteringMode                    `protobuf:"varint,12,opt,name=metering_mode,json=meteringMode,enum=Ydb.Topic.MeteringMode"`
	XXX_raceDetectHookData                       protoimpl.RaceDetectHookData
	XXX_presence                                 [1]uint32
	unknownFields                                protoimpl.UnknownFields
	sizeCache                                    protoimpl.SizeCache
...
func (x *CreateTopicRequest) ClearRetentionStorageMb() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_RetentionStorageMb = 0
}
...
func (x *CreateTopicRequest) ClearPartitionWriteSpeedBytesPerSecond() {
	...
	x.xxx_hidden_PartitionWriteSpeedBytesPerSecond = 0
}

func (x *CreateTopicRequest) ClearPartitionWriteBurstBytes() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 7)
	x.xxx_hidden_PartitionWriteBurstBytes = 0
}

func (x *CreateTopicRequest) ClearMeteringMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 10)
	x.xxx_hidden_MeteringMode = MeteringMode_METERING_MODE_UNSPECIFIED
}
...
type PartitionLocation struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_NodeId      int32                  `protobuf:"varint,1,opt,name=node_id,json=nodeId"`
	xxx_hidden_Generation  int64                  `protobuf:"varint,2,opt,name=generation"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
...
type DescribeTopicRequest struct {
	...
	xxx_hidden_IncludeLocation bool                            `protobuf:"varint,4,opt,name=include_location,json=includeLocation"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
func (x *DescribeTopicRequest) ClearIncludeLocation() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_IncludeLocation = false
}
...
type PartitionKeyRange struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_FromBound   []byte                 `protobuf:"bytes,1,opt,name=from_bound,json=fromBound"`
	xxx_hidden_ToBound     []byte                 `protobuf:"bytes,2,opt,name=to_bound,json=toBound"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type DescribeTopicResult struct {
	...
	xxx_hidden_PartitioningSettings                     *PartitioningSettings                 `protobuf:"bytes,2,opt,name=partitioning_settings,json=partitioningSettings"`
	xxx_hidden_Partitions                               *[]*DescribeTopicResult_PartitionInfo `protobuf:"bytes,3,rep,name=partitions"`
	xxx_hidden_RetentionPeriod                          *durationpb.Duration                  `protobuf:"bytes,4,opt,name=retention_period,json=retentionPeriod"`
	xxx_hidden_RetentionStorageMb                       int64                                 `protobuf:"varint,5,opt,name=retention_storage_mb,json=retentionStorageMb"`
	xxx_hidden_SupportedCodecs                          *SupportedCodecs                      `protobuf:"bytes,7,opt,name=supported_codecs,json=supportedCodecs"`
	xxx_hidden_PartitionWriteSpeedBytesPerSecond        int64                                 `protobuf:"varint,8,opt,name=partition_write_speed_bytes_per_second,json=partitionWriteSpeedBytesPerSecond"`
	xxx_hidden_PartitionTotalReadSpeedBytesPerSecond    int64                                 `protobuf:"varint,14,opt,name=partition_total_read_speed_bytes_per_second,json=partitionTotalReadSpeedBytesPerSecond"`
	xxx_hidden_PartitionConsumerReadSpeedBytesPerSecond int64                                 `protobuf:"varint,15,opt,name=partition_consumer_read_speed_bytes_per_second,json=partitionConsumerReadSpeedBytesPerSecond"`
	xxx_hidden_PartitionWriteBurstBytes                 int64                                 `protobuf:"varint,9,opt,name=partition_write_burst_bytes,json=partitionWriteBurstBytes"`
	xxx_hidden_Attributes                               map[string]string                     `protobuf:"bytes,10,rep,name=attributes" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Consumers                                *[]*Consumer                          `protobuf:"bytes,11,rep,name=consumers"`
	xxx_hidden_MeteringMode                             MeteringMode                          `protobuf:"varint,12,opt,name=metering_mode,json=meteringMode,enum=Ydb.Topic.MeteringMode"`
	xxx_hidden_TopicStats                               *DescribeTopicResult_TopicStats       `protobuf:"bytes,13,opt,name=topic_stats,json=topicStats"`
	XXX_raceDetectHookData                              protoimpl.RaceDetectHookData
	XXX_presence                                        [1]uint32
	unknownFields                                       protoimpl.UnknownFields
	sizeCache                                           protoimpl.SizeCache
...
func (x *DescribeTopicResult) ClearPartitionTotalReadSpeedBytesPerSecond() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 7)
	x.xxx_hidden_PartitionTotalReadSpeedBytesPerSecond = 0
}

func (x *DescribeTopicResult) ClearPartitionConsumerReadSpeedBytesPerSecond() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 8)
	x.xxx_hidden_PartitionConsumerReadSpeedBytesPerSecond = 0
}
...
func (b0 DescribeTopicResult_builder) Build() *DescribeTopicResult {
	...
	if b.PartitionTotalReadSpeedBytesPerSecond != nil {
	...
	if b.PartitionConsumerReadSpeedBytesPerSecond != nil {
...
type DescribePartitionRequest struct {
	...
	xxx_hidden_IncludeLocation bool                            `protobuf:"varint,5,opt,name=include_location,json=includeLocation"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type DescribePartitionResult struct {
	state                protoimpl.MessageState             `protogen:"opaque.v1"`
	xxx_hidden_Partition *DescribeTopicResult_PartitionInfo `protobuf:"bytes,1,opt,name=partition"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type DescribeConsumerRequest struct {
	...
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_Path            *string                         `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_Consumer        *string                         `protobuf:"bytes,3,opt,name=consumer"`
	xxx_hidden_IncludeStats    bool                            `protobuf:"varint,4,opt,name=include_stats,json=includeStats"`
	xxx_hidden_IncludeLocation bool                            `protobuf:"varint,5,opt,name=include_location,json=includeLocation"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
...
type DescribeConsumerResult struct {
	state                 protoimpl.MessageState                   `protogen:"opaque.v1"`
	xxx_hidden_Self       *Ydb_Scheme.Entry                        `protobuf:"bytes,1,opt,name=self"`
	xxx_hidden_Consumer   *Consumer                                `protobuf:"bytes,2,opt,name=consumer"`
	xxx_hidden_Partitions *[]*DescribeConsumerResult_PartitionInfo `protobuf:"bytes,3,rep,name=partitions"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type PartitionStats struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionOffsets *OffsetsRange          `protobuf:"bytes,1,opt,name=partition_offsets,json=partitionOffsets"`
	xxx_hidden_StoreSizeBytes   int64                  `protobuf:"varint,2,opt,name=store_size_bytes,json=storeSizeBytes"`
	xxx_hidden_LastWriteTime    *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=last_write_time,json=lastWriteTime"`
	xxx_hidden_MaxWriteTimeLag  *durationpb.Duration   `protobuf:"bytes,4,opt,name=max_write_time_lag,json=maxWriteTimeLag"`
	xxx_hidden_BytesWritten     *MultipleWindowsStat   `protobuf:"bytes,5,opt,name=bytes_written,json=bytesWritten"`
	xxx_hidden_PartitionNodeId  int32                  `protobuf:"varint,8,opt,name=partition_node_id,json=partitionNodeId"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *PartitionStats) ClearPartitionNodeId() {
	...
	x.xxx_hidden_PartitionNodeId = 0
}
...
type AlterTopicRequest struct {
	...
	xxx_hidden_OperationParams                      *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_Path                                 *string                         `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_AlterPartitioningSettings            *AlterPartitioningSettings      `protobuf:"bytes,3,opt,name=alter_partitioning_settings,json=alterPartitioningSettings"`
	xxx_hidden_SetRetentionPeriod                   *durationpb.Duration            `protobuf:"bytes,4,opt,name=set_retention_period,json=setRetentionPeriod"`
	xxx_hidden_SetRetentionStorageMb                int64                           `protobuf:"varint,5,opt,name=set_retention_storage_mb,json=setRetentionStorageMb"`
	xxx_hidden_SetSupportedCodecs                   *SupportedCodecs                `protobuf:"bytes,7,opt,name=set_supported_codecs,json=setSupportedCodecs"`
	xxx_hidden_SetPartitionWriteSpeedBytesPerSecond int64                           `protobuf:"varint,8,opt,name=set_partition_write_speed_bytes_per_second,json=setPartitionWriteSpeedBytesPerSecond"`
	xxx_hidden_SetPartitionWriteBurstBytes          int64                           `protobuf:"varint,9,opt,name=set_partition_write_burst_bytes,json=setPartitionWriteBurstBytes"`
	xxx_hidden_AlterAttributes                      map[string]string               `protobuf:"bytes,10,rep,name=alter_attributes,json=alterAttributes" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_AddConsumers                         *[]*Consumer                    `protobuf:"bytes,11,rep,name=add_consumers,json=addConsumers"`
	xxx_hidden_DropConsumers                        []string                        `protobuf:"bytes,12,rep,name=drop_consumers,json=dropConsumers"`
	xxx_hidden_AlterConsumers                       *[]*AlterConsumer               `protobuf:"bytes,13,rep,name=alter_consumers,json=alterConsumers"`
	xxx_hidden_SetMeteringMode                      MeteringMode                    `protobuf:"varint,14,opt,name=set_metering_mode,json=setMeteringMode,enum=Ydb.Topic.MeteringMode"`
	XXX_raceDetectHookData                          protoimpl.RaceDetectHookData
	XXX_presence                                    [1]uint32
	unknownFields                                   protoimpl.UnknownFields
	sizeCache                                       protoimpl.SizeCache
...
func (x *AlterTopicRequest) ClearSetMeteringMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 12)
	x.xxx_hidden_SetMeteringMode = MeteringMode_METERING_MODE_UNSPECIFIED
}
...
type StreamWriteMessage_InitRequest struct {
	...
	xxx_hidden_ProducerId       *string                                       `protobuf:"bytes,2,opt,name=producer_id,json=producerId"`
	xxx_hidden_WriteSessionMeta map[string]string                             `protobuf:"bytes,3,rep,name=write_session_meta,json=writeSessionMeta" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Partitioning     isStreamWriteMessage_InitRequest_Partitioning `protobuf_oneof:"partitioning"`
	xxx_hidden_GetLastSeqNo     bool                                          `protobuf:"varint,6,opt,name=get_last_seq_no,json=getLastSeqNo"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *StreamWriteMessage_InitRequest) ClearGetLastSeqNo() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_GetLastSeqNo = false
}
...
type StreamWriteMessage_InitResponse struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_LastSeqNo       int64                  `protobuf:"varint,1,opt,name=last_seq_no,json=lastSeqNo"`
	xxx_hidden_SessionId       *string                `protobuf:"bytes,2,opt,name=session_id,json=sessionId"`
	xxx_hidden_PartitionId     int64                  `protobuf:"varint,3,opt,name=partition_id,json=partitionId"`
	xxx_hidden_SupportedCodecs *SupportedCodecs       `protobuf:"bytes,4,opt,name=supported_codecs,json=supportedCodecs"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type StreamWriteMessage_WriteRequest struct {
	state                  protoimpl.MessageState                          `protogen:"opaque.v1"`
	xxx_hidden_Messages    *[]*StreamWriteMessage_WriteRequest_MessageData `protobuf:"bytes,1,rep,name=messages"`
	xxx_hidden_Codec       int32                                           `protobuf:"varint,2,opt,name=codec"`
	xxx_hidden_Tx          *TransactionIdentity                            `protobuf:"bytes,3,opt,name=tx"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type StreamWriteMessage_WriteResponse struct {
	state                      protoimpl.MessageState                            `protogen:"opaque.v1"`
	xxx_hidden_Acks            *[]*StreamWriteMessage_WriteResponse_WriteAck     `protobuf:"bytes,1,rep,name=acks"`
	xxx_hidden_PartitionId     int64                                             `protobuf:"varint,2,opt,name=partition_id,json=partitionId"`
	xxx_hidden_WriteStatistics *StreamWriteMessage_WriteResponse_WriteStatistics `protobuf:"bytes,3,opt,name=write_statistics,json=writeStatistics"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type StreamWriteMessage_WriteRequest_MessageData struct {
	...
	xxx_hidden_UncompressedSize int64                                                      `protobuf:"varint,4,opt,name=uncompressed_size,json=uncompressedSize"`
	xxx_hidden_Partitioning     isStreamWriteMessage_WriteRequest_MessageData_Partitioning `protobuf_oneof:"partitioning"`
	xxx_hidden_MetadataItems    *[]*MetadataItem                                           `protobuf:"bytes,7,rep,name=metadata_items,json=metadataItems"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *StreamWriteMessage_WriteRequest_MessageData) ClearUncompressedSize() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_UncompressedSize = 0
}
...
type StreamWriteMessage_WriteResponse_WriteStatistics struct {
	state                             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PersistingTime         *durationpb.Duration   `protobuf:"bytes,1,opt,name=persisting_time,json=persistingTime"`
	xxx_hidden_MinQueueWaitTime       *durationpb.Duration   `protobuf:"bytes,2,opt,name=min_queue_wait_time,json=minQueueWaitTime"`
	xxx_hidden_MaxQueueWaitTime       *durationpb.Duration   `protobuf:"bytes,3,opt,name=max_queue_wait_time,json=maxQueueWaitTime"`
	xxx_hidden_PartitionQuotaWaitTime *durationpb.Duration   `protobuf:"bytes,4,opt,name=partition_quota_wait_time,json=partitionQuotaWaitTime"`
	xxx_hidden_TopicQuotaWaitTime     *durationpb.Duration   `protobuf:"bytes,5,opt,name=topic_quota_wait_time,json=topicQuotaWaitTime"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
type StreamWriteMessage_WriteResponse_WriteAck_Skipped struct {
	state                  protoimpl.MessageState                                   `protogen:"opaque.v1"`
	xxx_hidden_Reason      StreamWriteMessage_WriteResponse_WriteAck_Skipped_Reason `protobuf:"varint,1,opt,name=reason,enum=Ydb.Topic.StreamWriteMessage_WriteResponse_WriteAck_Skipped_Reason"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *StreamWriteMessage_WriteResponse_WriteAck_Skipped) ClearReason() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_Reason = StreamWriteMessage_WriteResponse_WriteAck_Skipped_REASON_UNSPECIFIED
}
...
type StreamReadMessage_PartitionSession struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_Path               *string                `protobuf:"bytes,2,opt,name=path"`
	xxx_hidden_PartitionId        int64                  `protobuf:"varint,3,opt,name=partition_id,json=partitionId"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
...
func (x *StreamReadMessage_PartitionSession) ClearPartitionSessionId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_PartitionSessionId = 0
}
...
type StreamReadMessage_InitRequest struct {
	state                              protoimpl.MessageState                              `protogen:"opaque.v1"`
	xxx_hidden_TopicsReadSettings      *[]*StreamReadMessage_InitRequest_TopicReadSettings `protobuf:"bytes,1,rep,name=topics_read_settings,json=topicsReadSettings"`
	xxx_hidden_Consumer                *string                                             `protobuf:"bytes,2,opt,name=consumer"`
	xxx_hidden_ReaderName              *string                                             `protobuf:"bytes,3,opt,name=reader_name,json=readerName"`
	xxx_hidden_DirectRead              bool                                                `protobuf:"varint,4,opt,name=direct_read,json=directRead"`
	xxx_hidden_AutoPartitioningSupport bool                                                `protobuf:"varint,5,opt,name=auto_partitioning_support,json=autoPartitioningSupport"`
	XXX_raceDetectHookData             protoimpl.RaceDetectHookData
	XXX_presence                       [1]uint32
	unknownFields                      protoimpl.UnknownFields
	sizeCache                          protoimpl.SizeCache
...
func (x *StreamReadMessage_InitRequest) GetReaderName() string {
	if x != nil {
		if x.xxx_hidden_ReaderName != nil {
...
func (b0 StreamReadMessage_InitRequest_builder) Build() *StreamReadMessage_InitRequest {
	...
	if b.AutoPartitioningSupport != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 4, 5)
...
type StreamReadMessage_ReadRequest struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_BytesSize   int64                  `protobuf:"varint,1,opt,name=bytes_size,json=bytesSize"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type StreamReadMessage_ReadResponse struct {
	state                    protoimpl.MessageState                           `protogen:"opaque.v1"`
	xxx_hidden_PartitionData *[]*StreamReadMessage_ReadResponse_PartitionData `protobuf:"bytes,1,rep,name=partition_data,json=partitionData"`
...
type StreamReadMessage_CommitOffsetRequest struct {
	state                    protoimpl.MessageState                                          `protogen:"opaque.v1"`
	xxx_hidden_CommitOffsets *[]*StreamReadMessage_CommitOffsetRequest_PartitionCommitOffset `protobuf:"bytes,1,rep,name=commit_offsets,json=commitOffsets"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type StreamReadMessage_CommitOffsetResponse struct {
	state                                 protoimpl.MessageState                                              `protogen:"opaque.v1"`
	xxx_hidden_PartitionsCommittedOffsets *[]*StreamReadMessage_CommitOffsetResponse_PartitionCommittedOffset `protobuf:"bytes,1,rep,name=partitions_committed_offsets,json=partitionsCommittedOffsets"`
	unknownFields                         protoimpl.UnknownFields
	sizeCache                             protoimpl.SizeCache
}
...
type StreamReadMessage_PartitionSessionStatusResponse struct {
	state                             protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId     int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_PartitionOffsets       *OffsetsRange          `protobuf:"bytes,2,opt,name=partition_offsets,json=partitionOffsets"`
	xxx_hidden_CommittedOffset        int64                  `protobuf:"varint,3,opt,name=committed_offset,json=committedOffset"`
	xxx_hidden_WriteTimeHighWatermark *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=write_time_high_watermark,json=writeTimeHighWatermark"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
type StreamReadMessage_StartPartitionSessionRequest struct {
	state                        protoimpl.MessageState              `protogen:"opaque.v1"`
	xxx_hidden_PartitionSession  *StreamReadMessage_PartitionSession `protobuf:"bytes,1,opt,name=partition_session,json=partitionSession"`
	xxx_hidden_CommittedOffset   int64                               `protobuf:"varint,2,opt,name=committed_offset,json=committedOffset"`
	xxx_hidden_PartitionOffsets  *OffsetsRange                       `protobuf:"bytes,3,opt,name=partition_offsets,json=partitionOffsets"`
	xxx_hidden_PartitionLocation *PartitionLocation                  `protobuf:"bytes,4,opt,name=partition_location,json=partitionLocation"`
	XXX_raceDetectHookData       protoimpl.RaceDetectHookData
	XXX_presence                 [1]uint32
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
...
type StreamReadMessage_StartPartitionSessionResponse struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_ReadOffset         int64                  `protobuf:"varint,2,opt,name=read_offset,json=readOffset"`
	xxx_hidden_CommitOffset       int64                  `protobuf:"varint,3,opt,name=commit_offset,json=commitOffset"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type StreamReadMessage_StopPartitionSessionRequest struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_Graceful           bool                   `protobuf:"varint,2,opt,name=graceful"`
	xxx_hidden_CommittedOffset    int64                  `protobuf:"varint,3,opt,name=committed_offset,json=committedOffset"`
	xxx_hidden_LastDirectReadId   int64                  `protobuf:"varint,4,opt,name=last_direct_read_id,json=lastDirectReadId"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *StreamReadMessage_StopPartitionSessionRequest) ClearLastDirectReadId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_LastDirectReadId = 0
}
...
type StreamReadMessage_UpdatePartitionSession struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_PartitionLocation  *PartitionLocation     `protobuf:"bytes,2,opt,name=partition_location,json=partitionLocation"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type StreamReadMessage_DirectReadAck struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_DirectReadId       int64                  `protobuf:"varint,2,opt,name=direct_read_id,json=directReadId"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type StreamReadMessage_EndPartitionSession struct {
	state                           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId   int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_AdjacentPartitionIds []int64                `protobuf:"varint,2,rep,packed,name=adjacent_partition_ids,json=adjacentPartitionIds"`
	xxx_hidden_ChildPartitionIds    []int64                `protobuf:"varint,3,rep,packed,name=child_partition_ids,json=childPartitionIds"`
	XXX_raceDetectHookData          protoimpl.RaceDetectHookData
	XXX_presence                    [1]uint32
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
...
type StreamReadMessage_InitRequest_TopicReadSettings struct {
	state                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Path         *string                `protobuf:"bytes,1,opt,name=path"`
	xxx_hidden_PartitionIds []int64                `protobuf:"varint,2,rep,packed,name=partition_ids,json=partitionIds"`
	xxx_hidden_MaxLag       *durationpb.Duration   `protobuf:"bytes,3,opt,name=max_lag,json=maxLag"`
	xxx_hidden_ReadFrom     *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=read_from,json=readFrom"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
type StreamReadMessage_ReadResponse_MessageData struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Offset           int64                  `protobuf:"varint,1,opt,name=offset"`
	xxx_hidden_SeqNo            int64                  `protobuf:"varint,2,opt,name=seq_no,json=seqNo"`
	...
	xxx_hidden_UncompressedSize int64                  `protobuf:"varint,6,opt,name=uncompressed_size,json=uncompressedSize"`
	xxx_hidden_MessageGroupId   *string                `protobuf:"bytes,7,opt,name=message_group_id,json=messageGroupId"`
	xxx_hidden_MetadataItems    *[]*MetadataItem       `protobuf:"bytes,8,rep,name=metadata_items,json=metadataItems"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
func (x *StreamReadMessage_ReadResponse_MessageData) GetMessageGroupId() string {
	if x != nil {
		if x.xxx_hidden_MessageGroupId != nil {
...
func (x *StreamReadMessage_ReadResponse_MessageData) ClearMessageGroupId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
	x.xxx_hidden_MessageGroupId = nil
}
...
type StreamReadMessage_ReadResponse_Batch struct {
	state                       protoimpl.MessageState                         `protogen:"opaque.v1"`
	xxx_hidden_MessageData      *[]*StreamReadMessage_ReadResponse_MessageData `protobuf:"bytes,1,rep,name=message_data,json=messageData"`
	xxx_hidden_ProducerId       *string                                        `protobuf:"bytes,2,opt,name=producer_id,json=producerId"`
	xxx_hidden_WriteSessionMeta map[string]string                              `protobuf:"bytes,3,rep,name=write_session_meta,json=writeSessionMeta" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Codec            int32                                          `protobuf:"varint,4,opt,name=codec"`
	xxx_hidden_WrittenAt        *timestamppb.Timestamp                         `protobuf:"bytes,5,opt,name=written_at,json=writtenAt"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
type StreamReadMessage_ReadResponse_PartitionData struct {
	state                         protoimpl.MessageState                   `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                                    `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_Batches            *[]*StreamReadMessage_ReadResponse_Batch `protobuf:"bytes,2,rep,name=batches"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type StreamReadMessage_CommitOffsetRequest_PartitionCommitOffset struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_Offsets            *[]*OffsetsRange       `protobuf:"bytes,2,rep,name=offsets"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type StreamDirectReadMessage_InitRequest struct {
	state                         protoimpl.MessageState                                    `protogen:"opaque.v1"`
	xxx_hidden_SessionId          *string                                                   `protobuf:"bytes,1,opt,name=session_id,json=sessionId"`
	xxx_hidden_TopicsReadSettings *[]*StreamDirectReadMessage_InitRequest_TopicReadSettings `protobuf:"bytes,2,rep,name=topics_read_settings,json=topicsReadSettings"`
	xxx_hidden_Consumer           *string                                                   `protobuf:"bytes,3,opt,name=consumer"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
...
type StreamDirectReadMessage_StartDirectReadPartitionSessionRequest struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionSessionId int64                  `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_LastDirectReadId   int64                  `protobuf:"varint,2,opt,name=last_direct_read_id,json=lastDirectReadId"`
	xxx_hidden_Generation         int64                  `protobuf:"varint,3,opt,name=generation"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type StreamDirectReadMessage_StopDirectReadPartitionSession struct {
	...
	xxx_hidden_Status             Ydb.StatusIds_StatusCode   `protobuf:"varint,1,opt,name=status,enum=Ydb.StatusIds_StatusCode"`
	xxx_hidden_Issues             *[]*Ydb_Issue.IssueMessage `protobuf:"bytes,2,rep,name=issues"`
	xxx_hidden_PartitionSessionId int64                      `protobuf:"varint,3,opt,name=partition_session_id,json=partitionSessionId"`
...
type StreamDirectReadMessage_DirectReadResponse struct {
	...
	xxx_hidden_PartitionSessionId int64                                         `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId"`
	xxx_hidden_DirectReadId       int64                                         `protobuf:"varint,2,opt,name=direct_read_id,json=directReadId"`
	xxx_hidden_PartitionData      *StreamReadMessage_ReadResponse_PartitionData `protobuf:"bytes,3,opt,name=partition_data,json=partitionData"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type UpdateOffsetsInTransactionRequest_TopicOffsets struct {
	state                  protoimpl.MessageState                                              `protogen:"opaque.v1"`
	xxx_hidden_Path        *string                                                             `protobuf:"bytes,1,opt,name=path"`
	xxx_hidden_Partitions  *[]*UpdateOffsetsInTransactionRequest_TopicOffsets_PartitionOffsets `protobuf:"bytes,2,rep,name=partitions"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type UpdateOffsetsInTransactionRequest_TopicOffsets_PartitionOffsets struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PartitionId      int64                  `protobuf:"varint,1,opt,name=partition_id,json=partitionId"`
	xxx_hidden_PartitionOffsets *[]*OffsetsRange       `protobuf:"bytes,2,rep,name=partition_offsets,json=partitionOffsets"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
type Consumer_ConsumerStats struct {
	state                                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_MinPartitionsLastReadTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=min_partitions_last_read_time,json=minPartitionsLastReadTime"`
	xxx_hidden_MaxReadTimeLag            *durationpb.Duration   `protobuf:"bytes,2,opt,name=max_read_time_lag,json=maxReadTimeLag"`
	xxx_hidden_MaxWriteTimeLag           *durationpb.Duration   `protobuf:"bytes,3,opt,name=max_write_time_lag,json=maxWriteTimeLag"`
	xxx_hidden_BytesRead                 *MultipleWindowsStat   `protobuf:"bytes,4,opt,name=bytes_read,json=bytesRead"`
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
}
...
type DescribeTopicResult_PartitionInfo struct {
	...
	xxx_hidden_ChildPartitionIds  []int64                `protobuf:"varint,3,rep,packed,name=child_partition_ids,json=childPartitionIds"`
	xxx_hidden_ParentPartitionIds []int64                `protobuf:"varint,4,rep,packed,name=parent_partition_ids,json=parentPartitionIds"`
	xxx_hidden_PartitionStats     *PartitionStats        `protobuf:"bytes,5,opt,name=partition_stats,json=partitionStats"`
	xxx_hidden_PartitionLocation  *PartitionLocation     `protobuf:"bytes,6,opt,name=partition_location,json=partitionLocation"`
	xxx_hidden_KeyRange           *PartitionKeyRange     `protobuf:"bytes,7,opt,name=key_range,json=keyRange"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
type DescribeTopicResult_TopicStats struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_StoreSizeBytes   int64                  `protobuf:"varint,1,opt,name=store_size_bytes,json=storeSizeBytes"`
	xxx_hidden_MinLastWriteTime *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=min_last_write_time,json=minLastWriteTime"`
	xxx_hidden_MaxWriteTimeLag  *durationpb.Duration   `protobuf:"bytes,3,opt,name=max_write_time_lag,json=maxWriteTimeLag"`
	xxx_hidden_BytesWritten     *MultipleWindowsStat   `protobuf:"bytes,4,opt,name=bytes_written,json=bytesWritten"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
type DescribeConsumerResult_PartitionInfo struct {
	...
	xxx_hidden_ParentPartitionIds     []int64                                        `protobuf:"varint,4,rep,packed,name=parent_partition_ids,json=parentPartitionIds"`
	xxx_hidden_PartitionStats         *PartitionStats                                `protobuf:"bytes,5,opt,name=partition_stats,json=partitionStats"`
	xxx_hidden_PartitionConsumerStats *DescribeConsumerResult_PartitionConsumerStats `protobuf:"bytes,6,opt,name=partition_consumer_stats,json=partitionConsumerStats"`
	xxx_hidden_PartitionLocation      *PartitionLocation                             `protobuf:"bytes,7,opt,name=partition_location,json=partitionLocation"`
	XXX_raceDetectHookData            protoimpl.RaceDetectHookData
	XXX_presence                      [1]uint32
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
...
type DescribeConsumerResult_PartitionConsumerStats struct {
	state                                     protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_LastReadOffset                 int64                  `protobuf:"varint,1,opt,name=last_read_offset,json=lastReadOffset"`
	xxx_hidden_CommittedOffset                int64                  `protobuf:"varint,2,opt,name=committed_offset,json=committedOffset"`
	xxx_hidden_ReadSessionId                  *string                `protobuf:"bytes,3,opt,name=read_session_id,json=readSessionId"`
	xxx_hidden_PartitionReadSessionCreateTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=partition_read_session_create_time,json=partitionReadSessionCreateTime"`
	xxx_hidden_LastReadTime                   *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=last_read_time,json=lastReadTime"`
	xxx_hidden_MaxReadTimeLag                 *durationpb.Duration   `protobuf:"bytes,6,opt,name=max_read_time_lag,json=maxReadTimeLag"`
	xxx_hidden_MaxWriteTimeLag                *durationpb.Duration   `protobuf:"bytes,7,opt,name=max_write_time_lag,json=maxWriteTimeLag"`
	xxx_hidden_BytesRead                      *MultipleWindowsStat   `protobuf:"bytes,8,opt,name=bytes_read,json=bytesRead"`
	xxx_hidden_ReaderName                     *string                `protobuf:"bytes,11,opt,name=reader_name,json=readerName"`
	xxx_hidden_ConnectionNodeId               int32                  `protobuf:"varint,12,opt,name=connection_node_id,json=connectionNodeId"`
	XXX_raceDetectHookData                    protoimpl.RaceDetectHookData
	XXX_presence                              [1]uint32
	unknownFields                             protoimpl.UnknownFields
	sizeCache                                 protoimpl.SizeCache
...
func (x *DescribeConsumerResult_PartitionConsumerStats) GetReadSessionId() string {
	if x != nil {
		if x.xxx_hidden_ReadSessionId != nil {
...
func (x *DescribeConsumerResult_PartitionConsumerStats) ClearReadSessionId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_ReadSessionId = nil
}
...
func (x *DescribeConsumerResult_PartitionConsumerStats) ClearConnectionNodeId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 9)
	x.xxx_hidden_ConnectionNodeId = 0
}
