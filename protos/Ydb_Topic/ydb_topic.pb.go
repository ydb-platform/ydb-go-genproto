...
// Metering mode specifies the method used to determine consumption of resources
// by the topic. This settings will have an effect only in a serverless
// database.
...
type Consumer struct {
	...
	// Consumer may be marked as 'important'. It means messages for this
	// consumer will never expire due to retention. User should take care that
	// such consumer never stalls, to prevent running out of disk space. Flag
	// that this consumer is important.
	Important bool `protobuf:"varint,2,opt,name=important,proto3" json:"important,omitempty"`
	// All messages with smaller server written_at timestamp will be skipped.
	ReadFrom *timestamp.Timestamp `protobuf:"bytes,3,opt,name=read_from,json=readFrom,proto3" json:"read_from,omitempty"`
...
func (x *Consumer) GetReadFrom() *timestamp.Timestamp {
	if x != nil {
		return x.ReadFrom
	}
	return nil
...
type AlterConsumer struct {
	...
	// such consumer never stalls, to prevent running out of disk space. Flag
	// that this consumer is important.
	SetImportant bool `protobuf:"varint,2,opt,name=set_important,json=setImportant,proto3" json:"set_important,omitempty"`
	// All messages with smaller server written_at timestamp will be skipped.
	SetReadFrom *timestamp.Timestamp `protobuf:"bytes,3,opt,name=set_read_from,json=setReadFrom,proto3" json:"set_read_from,omitempty"`
	// List of supported codecs by this consumer.
	// supported_codecs on topic must be contained inside this list.
	...
	// User and server attributes of consumer. Server attributes starts from "_"
	// and will be validated by server. Leave the value blank to drop an
	// attribute.
...
func (x *AlterConsumer) GetSetReadFrom() *timestamp.Timestamp {
	if x != nil {
...
type PartitioningSettings struct {
	...
	// Limit for total partition count, including active (open for write) and
	// read-only partitions. Zero value means default - 100.
...
type AlterPartitioningSettings struct {
	...
	// Minimum partition count auto merge would stop working at.
	// Zero value means default - 1.
	SetMinActivePartitions int64 `protobuf:"varint,1,opt,name=set_min_active_partitions,json=setMinActivePartitions,proto3" json:"set_min_active_partitions,omitempty"`
	// Limit for total partition count, including active (open for write) and
	// read-only partitions. Zero value means default - 100.
	SetPartitionCountLimit int64 `protobuf:"varint,2,opt,name=set_partition_count_limit,json=setPartitionCountLimit,proto3" json:"set_partition_count_limit,omitempty"`
}
...
type CreateTopicRequest struct {
	...
	//
	// How long data in partition should be stored. Must be greater than 0 and
	// less than limit for this database. Default limit - 36 hours.
	...
	// How much data in partition should be stored. Must be greater than 0 and
	// less than limit for this database. Zero value means infinite limit.
	...
	// Partition write speed in bytes per second. Must be less than database
	// limit. Zero value means default limit: 1 MB per second.
	...
	// Burst size for write in partition, in bytes. Must be less than database
	// limit. Zero value means default limit: 1 MB.
	...
	// User and server attributes of topic. Server attributes starts from "_"
	// and will be validated by server.
...
func (x *CreateTopicRequest) GetRetentionPeriod() *duration.Duration {
	if x != nil {
...
func (x *DescribeTopicResult) GetRetentionPeriod() *duration.Duration {
	if x != nil {
		return x.RetentionPeriod
	}
	return nil
...
type PartitionStats struct {
	...
	LastWriteTime *timestamp.Timestamp `protobuf:"bytes,3,opt,name=last_write_time,json=lastWriteTime,proto3" json:"last_write_time,omitempty"`
	// Maximum of differences between write timestamp and create timestamp for
	// all messages, written during last minute.
	MaxWriteTimeLag *duration.Duration `protobuf:"bytes,4,opt,name=max_write_time_lag,json=maxWriteTimeLag,proto3" json:"max_write_time_lag,omitempty"`
	...
	// Host where tablet for this partition works. Useful for debugging
	// purposes.
...
func (x *PartitionStats) GetLastWriteTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *PartitionStats) GetMaxWriteTimeLag() *duration.Duration {
	if x != nil {
...
type AlterTopicRequest struct {
	...
	// How long data in partition should be stored. Must be greater than 0 and
	// less than limit for this database. Default limit - 36 hours.
	SetRetentionPeriod *duration.Duration `protobuf:"bytes,4,opt,name=set_retention_period,json=setRetentionPeriod,proto3" json:"set_retention_period,omitempty"`
	// How much data in partition should be stored. Must be greater than 0 and
	// less than limit for this database.
	SetRetentionStorageMb int64 `protobuf:"varint,5,opt,name=set_retention_storage_mb,json=setRetentionStorageMb,proto3" json:"set_retention_storage_mb,omitempty"`
	// List of allowed codecs for writers.
	// Writes with codec not from this list are forbidden.
	...
	// Partition write speed in bytes per second. Must be less than database
	// limit. Default limit - 1 MB/s.
	SetPartitionWriteSpeedBytesPerSecond int64 `protobuf:"varint,8,opt,name=set_partition_write_speed_bytes_per_second,json=setPartitionWriteSpeedBytesPerSecond,proto3" json:"set_partition_write_speed_bytes_per_second,omitempty"`
	// Burst size for write in partition, in bytes. Must be less than database
	// limit. Default limit - 1 MB.
	SetPartitionWriteBurstBytes int64 `protobuf:"varint,9,opt,name=set_partition_write_burst_bytes,json=setPartitionWriteBurstBytes,proto3" json:"set_partition_write_burst_bytes,omitempty"`
	// User and server attributes of topic. Server attributes starts from "_"
	// and will be validated by server. Leave the value blank to drop an
	// attribute.
...
func (x *AlterTopicRequest) GetSetRetentionPeriod() *duration.Duration {
	if x != nil {
...
// Server-client message for write session. Contains either non-success
// status, or one of:
//
//	InitResponse - correct handshake response.
//	WriteResponse - acknowledgment of storing client messages.
//	UpdateTokenResponse - acknowledgment of reauthentication and
//	reauthorization.
...
type StreamWriteMessage_InitRequest struct {
	...
	// If neither is set, no guarantees on ordering or partitions to write
	// to.
	//
...
type StreamWriteMessage_InitRequest_MessageGroupId struct {
	// All messages with given pair (producer_id, message_group_id) go
	// to single partition in order of writes.
...
type StreamWriteMessage_InitResponse struct {
	...
	// Client can only use compression codecs from this set to write
	// messages to topic. Otherwise session will be closed with BAD_REQUEST.
...
// This sequence is persisted together so write statistics is for messages
// batch.
type StreamWriteMessage_WriteResponse struct {
	...
	// Number of acks is equal to number of messages in the corresponding
	// WriteRequests.
...
func (x *StreamWriteMessage_WriteRequest_MessageData) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
type StreamWriteMessage_WriteRequest_MessageData_MessageGroupId struct {
	// All messages with given pair (producer_id, message_group_id)
	// go to single partition in order of writes.
...
type StreamWriteMessage_WriteResponse_WriteStatistics struct {
	...
	// Time spent in persisting of data. Same for each message in
	// response.
	PersistingTime *duration.Duration `protobuf:"bytes,1,opt,name=persisting_time,json=persistingTime,proto3" json:"persisting_time,omitempty"`
	// Time spent in queue before persisting, minimal of all messages in
	// response.
	MinQueueWaitTime *duration.Duration `protobuf:"bytes,2,opt,name=min_queue_wait_time,json=minQueueWaitTime,proto3" json:"min_queue_wait_time,omitempty"`
	// Time spent in queue before persisting, maximal of all messages in
	// response.
	MaxQueueWaitTime *duration.Duration `protobuf:"bytes,3,opt,name=max_queue_wait_time,json=maxQueueWaitTime,proto3" json:"max_queue_wait_time,omitempty"`
	// Time spent awaiting for partition write quota. Same for each
	// message in response.
	PartitionQuotaWaitTime *duration.Duration `protobuf:"bytes,4,opt,name=partition_quota_wait_time,json=partitionQuotaWaitTime,proto3" json:"partition_quota_wait_time,omitempty"`
	// Time spent awaiting for topic write quota. Same for each message
	// in response.
	TopicQuotaWaitTime *duration.Duration `protobuf:"bytes,5,opt,name=topic_quota_wait_time,json=topicQuotaWaitTime,proto3" json:"topic_quota_wait_time,omitempty"`
}
...
func (x *StreamWriteMessage_WriteResponse_WriteStatistics) GetPersistingTime() *duration.Duration {
	if x != nil {
...
func (x *StreamWriteMessage_WriteResponse_WriteStatistics) GetMinQueueWaitTime() *duration.Duration {
	if x != nil {
...
func (x *StreamWriteMessage_WriteResponse_WriteStatistics) GetMaxQueueWaitTime() *duration.Duration {
	if x != nil {
...
func (x *StreamWriteMessage_WriteResponse_WriteStatistics) GetPartitionQuotaWaitTime() *duration.Duration {
	if x != nil {
...
func (x *StreamWriteMessage_WriteResponse_WriteStatistics) GetTopicQuotaWaitTime() *duration.Duration {
	if x != nil {
...
// Within a StreamRead session delivered messages are separated by
// partition. Reads from a single partition are represented by a partition
// session.
...
//
//	StartPartitionSessionResponse - Response to
//	StreamReadServerMessage.StartPartitionSessionRequest.
//	    Client signals it is ready to get data from partition.
//	StopPartitionSessionResponse - Response to
//	StreamReadServerMessage.StopPartitionSessionRequest.
//	    Client signals it has finished working with partition. Mandatory
//	    for graceful stop,  otherwise.
...
//	PartitionSessionStatusResponse - server response with partition
//	session status. UpdateTokenResponse - acknowledgment of token update.
//
//	StartPartitionSessionRequest - command from server to create a
//	partition session. StopPartitionSessionRequest - command from server
//	to destroy a partition session.
...
type StreamReadMessage_ReadRequest struct {
	...
	// Server and client each keep track of total bytes size of all
	// ReadResponses. When client is ready to receive N more bytes in
	// responses (to increment possible total by N), it sends a ReadRequest
	// with bytes_size = N. bytes_size value must be positive. So in
	// expression 'A = (sum of bytes_size in all ReadRequests) - (sum of
	// bytes_size in all ReadResponses)'
	//
	//	server will keep A (available size for responses) non-negative.
	//
	// But there is an exception. If server receives ReadRequest, and the
	// first message in response exceeds A - then it will still be
	// delivered, and A will become negative until enough additional
	// ReadRequests.
	//
	// Example:
	// 1) Let client have 200 bytes buffer. It sends ReadRequest with
	// bytes_size = 200; 2) Server may return one ReadResponse with
	// bytes_size = 70 and than another 80 bytes response;
	//
	//	now client buffer has 50 free bytes, server is free to send up to
	//	50 bytes in responses.
	//
	// 3) Client processes 100 bytes from buffer, now buffer free space is
	// 150 bytes,
	//
	//	so client sends ReadRequest with bytes_size = 100;
	//
	// 4) Server is free to send up to 50 + 100 = 150 bytes. But the next
	// read message is too big,
	//
	//	and it sends 160 bytes ReadResponse.
	//
	// 5) Let's assume client somehow processes it, and its 200 bytes buffer
	// is free again.
	//
	//	It shoud account for excess 10 bytes and send ReadRequest with
	//	bytes_size = 210.
...
type StreamReadMessage_PartitionSessionStatusResponse struct {
	...
	// Each offset up to and including (committed_offset - 1) was fully
	// processed.
	...
	// Write timestamp of next message written to this partition will be no
	// less than write_time_high_watermark.
	WriteTimeHighWatermark *timestamp.Timestamp `protobuf:"bytes,4,opt,name=write_time_high_watermark,json=writeTimeHighWatermark,proto3" json:"write_time_high_watermark,omitempty"`
}
...
func (x *StreamReadMessage_PartitionSessionStatusResponse) GetWriteTimeHighWatermark() *timestamp.Timestamp {
	if x != nil {
...
// Client must respond with StartPartitionSessionResponse when ready to
// receive data from this partition.
...
type StreamReadMessage_StartPartitionSessionResponse struct {
	...
	PartitionSessionId int64 `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId,proto3" json:"partition_session_id,omitempty"`
	// Reads in this partition session will start from offset no less than
	// read_offset. If read_offset is set, server will check that
	// read_offset is no less that actual committed offset. If check fails
	// then server will send an error message (status != SUCCESS) and close
	// stream.
	//
	// If read_offset is not set, no check will be made.
	// InitRequest.max_lag and InitRequest.read_from could lead to skip of
	// more messages. Server will return data starting from offset that is
	// maximum of actual committed offset, read_offset (if set) and offsets
	// calculated from InitRequest.max_lag and InitRequest.read_from.
	ReadOffset int64 `protobuf:"varint,2,opt,name=read_offset,json=readOffset,proto3" json:"read_offset,omitempty"`
	// All messages with offset less than commit_offset are processed by
	// client. Server will commit this position if this is not done yet.
...
type StreamReadMessage_StopPartitionSessionRequest struct {
	...
	// If set, server will wait for response from client before giving this
	// partition to other read session. Server will not send more data from
	// this partition. Client can process all received data and wait for
	// commit and only after send response. If False then server gives
	// partition for other session right now. All further commits for this
	// partition session has no effect. Server is not waiting for response.
...
// Must be sent only after corresponding StopPartitionSessionRequest from
// server. Server will give this partition to other read session only after
// StopPartitionSessionResponse signal.
type StreamReadMessage_StopPartitionSessionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Partition session identifier of partition session that is released by
	// client.
	PartitionSessionId int64 `protobuf:"varint,1,opt,name=partition_session_id,json=partitionSessionId,proto3" json:"partition_session_id,omitempty"`
}
...
type StreamReadMessage_InitRequest_TopicReadSettings struct {
	...
	// Skip all messages that has write timestamp smaller than now -
	// max_lag. Zero means infinite lag.
	MaxLag *duration.Duration `protobuf:"bytes,3,opt,name=max_lag,json=maxLag,proto3" json:"max_lag,omitempty"`
	// Read data only after this timestamp from this topic.
	// Read only messages with 'written_at' value greater or equal than
	// this timestamp.
	ReadFrom *timestamp.Timestamp `protobuf:"bytes,4,opt,name=read_from,json=readFrom,proto3" json:"read_from,omitempty"`
}
...
func (x *StreamReadMessage_InitRequest_TopicReadSettings) GetMaxLag() *duration.Duration {
	if x != nil {
		return x.MaxLag
	}
	return nil
...
func (x *StreamReadMessage_InitRequest_TopicReadSettings) GetReadFrom() *timestamp.Timestamp {
	if x != nil {
		return x.ReadFrom
	}
	return nil
...
type StreamReadMessage_ReadResponse_MessageData struct {
	...
	Offset int64 `protobuf:"varint,1,opt,name=offset,proto3" json:"offset,omitempty"` // unique value for clientside deduplication -
	...
	// Uncompressed size of client message body.
	// sent as is from WriteRequest, without check on server side. May
	// be empty (for writes from old client) or wrong (if bug in
	// writer). Use it for optimization purposes only, don't trust it.
...
func (x *StreamReadMessage_ReadResponse_MessageData) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
type StreamReadMessage_ReadResponse_Batch struct {
	...
	// Producer identifier provided by client for this batch of client
	// messages.
	ProducerId string `protobuf:"bytes,2,opt,name=producer_id,json=producerId,proto3" json:"producer_id,omitempty"`
	// Client metadata attached to write session, the same for all
	// messages in batch.
	WriteSessionMeta map[string]string `protobuf:"bytes,3,rep,name=write_session_meta,json=writeSessionMeta,proto3" json:"write_session_meta,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Codec that is used for data compression.
	// See enum Codec above for values.
...
func (x *StreamReadMessage_ReadResponse_Batch) GetWrittenAt() *timestamp.Timestamp {
	if x != nil {
		return x.WrittenAt
	}
	return nil
...
type Consumer_ConsumerStats struct {
	...
	MinPartitionsLastReadTime *timestamp.Timestamp `protobuf:"bytes,1,opt,name=min_partitions_last_read_time,json=minPartitionsLastReadTime,proto3" json:"min_partitions_last_read_time,omitempty"`
	// Maximum of differences between timestamp of read and write timestamp
	// for all messages, read during last minute.
	MaxReadTimeLag *duration.Duration `protobuf:"bytes,2,opt,name=max_read_time_lag,json=maxReadTimeLag,proto3" json:"max_read_time_lag,omitempty"`
	// Maximum of differences between write timestamp and create timestamp
	// for all messages, read during last minute.
	MaxWriteTimeLag *duration.Duration `protobuf:"bytes,3,opt,name=max_write_time_lag,json=maxWriteTimeLag,proto3" json:"max_write_time_lag,omitempty"`
	// Bytes read stastics.
...
func (*Consumer_ConsumerStats) Descriptor() ([]byte, []int) {
	return file_protos_ydb_topic_proto_rawDescGZIP(), []int{10, 1}
}

func (x *Consumer_ConsumerStats) GetMinPartitionsLastReadTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *Consumer_ConsumerStats) GetMaxReadTimeLag() *duration.Duration {
	if x != nil {
...
func (x *Consumer_ConsumerStats) GetMaxWriteTimeLag() *duration.Duration {
	if x != nil {
		return x.MaxWriteTimeLag
	}
	return nil
...
type DescribeTopicResult_PartitionInfo struct {
	...
	// Ids of partitions which was formed when this partition was split or
	// merged.
	...
	// Ids of partitions from which this partition was formed by split or
	// merge.
	...
	// Stats for partition, filled only when include_stats in request is
	// true.
...
func (*DescribeTopicResult_PartitionInfo) Descriptor() ([]byte, []int) {
	return file_protos_ydb_topic_proto_rawDescGZIP(), []int{19, 1}
}
...
type DescribeTopicResult_TopicStats struct {
	...
	MinLastWriteTime *timestamp.Timestamp `protobuf:"bytes,2,opt,name=min_last_write_time,json=minLastWriteTime,proto3" json:"min_last_write_time,omitempty"`
	// Maximum of differences between write timestamp and create timestamp
	// for all messages, written during last minute.
	MaxWriteTimeLag *duration.Duration `protobuf:"bytes,3,opt,name=max_write_time_lag,json=maxWriteTimeLag,proto3" json:"max_write_time_lag,omitempty"`
...
func (*DescribeTopicResult_TopicStats) Descriptor() ([]byte, []int) {
	return file_protos_ydb_topic_proto_rawDescGZIP(), []int{19, 2}
}
...
func (x *DescribeTopicResult_TopicStats) GetMinLastWriteTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *DescribeTopicResult_TopicStats) GetMaxWriteTimeLag() *duration.Duration {
	if x != nil {
		return x.MaxWriteTimeLag
	}
	return nil
...
type DescribeConsumerResult_PartitionInfo struct {
	...
	// true.
	PartitionStats *PartitionStats `protobuf:"bytes,5,opt,name=partition_stats,json=partitionStats,proto3" json:"partition_stats,omitempty"`
	// Stats for consumer of this partition, filled only when include_stats
	// in request is true.
...
func (*DescribeConsumerResult_PartitionInfo) Descriptor() ([]byte, []int) {
	return file_protos_ydb_topic_proto_rawDescGZIP(), []int{22, 0}
}
...
type DescribeConsumerResult_PartitionConsumerStats struct {
	...
	PartitionReadSessionCreateTime *timestamp.Timestamp `protobuf:"bytes,4,opt,name=partition_read_session_create_time,json=partitionReadSessionCreateTime,proto3" json:"partition_read_session_create_time,omitempty"`
	// Timestamp of last read from this partition.
	LastReadTime *timestamp.Timestamp `protobuf:"bytes,5,opt,name=last_read_time,json=lastReadTime,proto3" json:"last_read_time,omitempty"`
	// Maximum of differences between timestamp of read and write timestamp
	// for all messages, read during last minute.
	MaxReadTimeLag *duration.Duration `protobuf:"bytes,6,opt,name=max_read_time_lag,json=maxReadTimeLag,proto3" json:"max_read_time_lag,omitempty"`
	// Maximum of differences between write timestamp and create timestamp
	// for all messages, read during last minute.
	MaxWriteTimeLag *duration.Duration `protobuf:"bytes,7,opt,name=max_write_time_lag,json=maxWriteTimeLag,proto3" json:"max_write_time_lag,omitempty"`
	// How much bytes were read during several windows statistics from this
	// partiton.
...
func (x *DescribeConsumerResult_PartitionConsumerStats) GetPartitionReadSessionCreateTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *DescribeConsumerResult_PartitionConsumerStats) GetLastReadTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *DescribeConsumerResult_PartitionConsumerStats) GetMaxReadTimeLag() *duration.Duration {
	if x != nil {
		return x.MaxReadTimeLag
	}
	return nil
...
func (x *DescribeConsumerResult_PartitionConsumerStats) GetMaxWriteTimeLag() *duration.Duration {
	if x != nil {
		return x.MaxWriteTimeLag
	}
	return nil
...
var file_protos_ydb_topic_proto_rawDesc = []byte{
	...
	0x63, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x57, 0x61, 0x69, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x8b,
	...
	0x64, 0x62, 0x2e, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x2e, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x73,
	0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x10, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x73, 0x1a, 0x97, 0x01, 0x0a, 0x1d, 0x53, 0x74, 0x61, 0x72,
	0x74, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	0x6f, 0x6e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72,
	0x65, 0x61, 0x64, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x23, 0x0a, 0x0d,
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x4f, 0x66, 0x66, 0x73, 0x65,
	0x74, 0x1a, 0x96, 0x01, 0x0a, 0x1b, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x64, 0x65, 0x63, 0x73, 0x12, 0x43, 0x0a, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x59, 0x64, 0x62, 0x2e,
	0x54, 0x6f, 0x70, 0x69, 0x63, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x2e, 0x41,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a,
	0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x48, 0x0a, 0x0e, 0x63, 0x6f,
	0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x59, 0x64, 0x62, 0x2e, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x2e, 0x43,
	...
	0x74, 0x61, 0x74, 0x73, 0x1a, 0x3d, 0x0a, 0x0f, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
	0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x1a, 0xba, 0x02, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72,
	...
	0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0xfa, 0x02, 0x0a, 0x0d, 0x41, 0x6c, 0x74, 0x65, 0x72,
	...
	,
	...
	0x04, 0x10, 0x05, 0x22, 0x92, 0x01, 0x0a, 0x14, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x3c, 0x0a, 0x15,
	...
	,
	...
	0xb2, 0xe6, 0x2a, 0x04, 0x3e, 0x3d, 0x20, 0x30, 0x52, 0x16, 0x73, 0x65, 0x74, 0x50, 0x61, 0x72,
	...
	0x64, 0x65, 0x49, 0x64, 0x22, 0x97, 0x08, 0x0a, 0x11, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x54, 0x6f,
	...
	0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x12, 0x41, 0x0a,
	...
	0x08, 0xb2, 0xe6, 0x2a, 0x04, 0x3e, 0x3d, 0x20, 0x30, 0x52, 0x15, 0x73, 0x65, 0x74, 0x52, 0x65,
	...
	,
	...
	0x04, 0x3e, 0x3d, 0x20, 0x30, 0x52, 0x1b, 0x73, 0x65, 0x74, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x57, 0x72, 0x69, 0x74, 0x65, 0x42, 0x75, 0x72, 0x73, 0x74, 0x42, 0x79, 0x74,
	0x65, 0x73, 0x12, 0x5c, 0x0a, 0x10, 0x61, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x61, 0x74, 0x74, 0x72,
	...
	,
	...
	0x22, 0x0a, 0x08, 0xa0, 0x9c, 0x01, 0x10, 0xff, 0xff, 0xff, 0xff, 0x07, 0x2a, 0x73, 0x0a, 0x0c,
	...
	0x02, 0x42, 0x4d, 0x0a, 0x0e, 0x74, 0x65, 0x63, 0x68, 0x2e, 0x79, 0x64, 0x62, 0x2e, 0x74, 0x6f,
...
var file_protos_ydb_topic_proto_msgTypes = make([]protoimpl.MessageInfo, 76)
var file_protos_ydb_topic_proto_goTypes = []interface{}{
	...
	(*MultipleWindowsStat)(nil),                               // 12: Ydb.Topic.MultipleWindowsStat
	(*Consumer)(nil),                                          // 13: Ydb.Topic.Consumer
	(*AlterConsumer)(nil),                                     // 14: Ydb.Topic.AlterConsumer
	(*PartitioningSettings)(nil),                              // 15: Ydb.Topic.PartitioningSettings
	(*AlterPartitioningSettings)(nil),                         // 16: Ydb.Topic.AlterPartitioningSettings
	(*CreateTopicRequest)(nil),                                // 17: Ydb.Topic.CreateTopicRequest
	(*CreateTopicResponse)(nil),                               // 18: Ydb.Topic.CreateTopicResponse
	(*CreateTopicResult)(nil),                                 // 19: Ydb.Topic.CreateTopicResult
	(*DescribeTopicRequest)(nil),                              // 20: Ydb.Topic.DescribeTopicRequest
	(*DescribeTopicResponse)(nil),                             // 21: Ydb.Topic.DescribeTopicResponse
	(*DescribeTopicResult)(nil),                               // 22: Ydb.Topic.DescribeTopicResult
	(*DescribeConsumerRequest)(nil),                           // 23: Ydb.Topic.DescribeConsumerRequest
	(*DescribeConsumerResponse)(nil),                          // 24: Ydb.Topic.DescribeConsumerResponse
	(*DescribeConsumerResult)(nil),                            // 25: Ydb.Topic.DescribeConsumerResult
	(*PartitionStats)(nil),                                    // 26: Ydb.Topic.PartitionStats
	(*AlterTopicRequest)(nil),                                 // 27: Ydb.Topic.AlterTopicRequest
	(*AlterTopicResponse)(nil),                                // 28: Ydb.Topic.AlterTopicResponse
	(*AlterTopicResult)(nil),                                  // 29: Ydb.Topic.AlterTopicResult
	(*DropTopicRequest)(nil),                                  // 30: Ydb.Topic.DropTopicRequest
	(*DropTopicResponse)(nil),                                 // 31: Ydb.Topic.DropTopicResponse
	(*DropTopicResult)(nil),                                   // 32: Ydb.Topic.DropTopicResult
	(*StreamWriteMessage_FromClient)(nil),                     // 33: Ydb.Topic.StreamWriteMessage.FromClient
	(*StreamWriteMessage_FromServer)(nil),                     // 34: Ydb.Topic.StreamWriteMessage.FromServer
	(*StreamWriteMessage_InitRequest)(nil),                    // 35: Ydb.Topic.StreamWriteMessage.InitRequest
	(*StreamWriteMessage_InitResponse)(nil),                   // 36: Ydb.Topic.StreamWriteMessage.InitResponse
	(*StreamWriteMessage_WriteRequest)(nil),                   // 37: Ydb.Topic.StreamWriteMessage.WriteRequest
	(*StreamWriteMessage_WriteResponse)(nil),                  // 38: Ydb.Topic.StreamWriteMessage.WriteResponse
	nil,                                                       // 39: Ydb.Topic.StreamWriteMessage.InitRequest.WriteSessionMetaEntry
	(*StreamWriteMessage_WriteRequest_MessageData)(nil),       // 40: Ydb.Topic.StreamWriteMessage.WriteRequest.MessageData
	(*StreamWriteMessage_WriteResponse_WriteAck)(nil),         // 41: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck
	(*StreamWriteMessage_WriteResponse_WriteStatistics)(nil),  // 42: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics
	(*StreamWriteMessage_WriteResponse_WriteAck_Written)(nil), // 43: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.Written
	(*StreamWriteMessage_WriteResponse_WriteAck_Skipped)(nil), // 44: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.Skipped
	(*StreamReadMessage_PartitionSession)(nil),                // 45: Ydb.Topic.StreamReadMessage.PartitionSession
	(*StreamReadMessage_FromClient)(nil),                      // 46: Ydb.Topic.StreamReadMessage.FromClient
	(*StreamReadMessage_FromServer)(nil),                      // 47: Ydb.Topic.StreamReadMessage.FromServer
	(*StreamReadMessage_InitRequest)(nil),                     // 48: Ydb.Topic.StreamReadMessage.InitRequest
	(*StreamReadMessage_InitResponse)(nil),                    // 49: Ydb.Topic.StreamReadMessage.InitResponse
	(*StreamReadMessage_ReadRequest)(nil),                     // 50: Ydb.Topic.StreamReadMessage.ReadRequest
	(*StreamReadMessage_ReadResponse)(nil),                    // 51: Ydb.Topic.StreamReadMessage.ReadResponse
	(*StreamReadMessage_CommitOffsetRequest)(nil),             // 52: Ydb.Topic.StreamReadMessage.CommitOffsetRequest
	(*StreamReadMessage_CommitOffsetResponse)(nil),            // 53: Ydb.Topic.StreamReadMessage.CommitOffsetResponse
	(*StreamReadMessage_PartitionSessionStatusRequest)(nil),   // 54: Ydb.Topic.StreamReadMessage.PartitionSessionStatusRequest
	(*StreamReadMessage_PartitionSessionStatusResponse)(nil),  // 55: Ydb.Topic.StreamReadMessage.PartitionSessionStatusResponse
	(*StreamReadMessage_StartPartitionSessionRequest)(nil),    // 56: Ydb.Topic.StreamReadMessage.StartPartitionSessionRequest
	(*StreamReadMessage_StartPartitionSessionResponse)(nil),   // 57: Ydb.Topic.StreamReadMessage.StartPartitionSessionResponse
	(*StreamReadMessage_StopPartitionSessionRequest)(nil),     // 58: Ydb.Topic.StreamReadMessage.StopPartitionSessionRequest
	(*StreamReadMessage_StopPartitionSessionResponse)(nil),    // 59: Ydb.Topic.StreamReadMessage.StopPartitionSessionResponse
	(*StreamReadMessage_InitRequest_TopicReadSettings)(nil),   // 60: Ydb.Topic.StreamReadMessage.InitRequest.TopicReadSettings
	(*StreamReadMessage_ReadResponse_MessageData)(nil),        // 61: Ydb.Topic.StreamReadMessage.ReadResponse.MessageData
	(*StreamReadMessage_ReadResponse_Batch)(nil),              // 62: Ydb.Topic.StreamReadMessage.ReadResponse.Batch
	(*StreamReadMessage_ReadResponse_PartitionData)(nil),      // 63: Ydb.Topic.StreamReadMessage.ReadResponse.PartitionData
	nil, // 64: Ydb.Topic.StreamReadMessage.ReadResponse.Batch.WriteSessionMetaEntry
	(*StreamReadMessage_CommitOffsetRequest_PartitionCommitOffset)(nil),     // 65: Ydb.Topic.StreamReadMessage.CommitOffsetRequest.PartitionCommitOffset
	(*StreamReadMessage_CommitOffsetResponse_PartitionCommittedOffset)(nil), // 66: Ydb.Topic.StreamReadMessage.CommitOffsetResponse.PartitionCommittedOffset
	(*AddOffsetsToTransactionRequest_TopicOffsets)(nil),                     // 67: Ydb.Topic.AddOffsetsToTransactionRequest.TopicOffsets
	(*AddOffsetsToTransactionRequest_TopicOffsets_PartitionOffsets)(nil),    // 68: Ydb.Topic.AddOffsetsToTransactionRequest.TopicOffsets.PartitionOffsets
	nil,                            // 69: Ydb.Topic.Consumer.AttributesEntry
	(*Consumer_ConsumerStats)(nil), // 70: Ydb.Topic.Consumer.ConsumerStats
	nil,                            // 71: Ydb.Topic.AlterConsumer.AlterAttributesEntry
	nil,                            // 72: Ydb.Topic.CreateTopicRequest.AttributesEntry
	nil,                            // 73: Ydb.Topic.DescribeTopicResult.AttributesEntry
	(*DescribeTopicResult_PartitionInfo)(nil),             // 74: Ydb.Topic.DescribeTopicResult.PartitionInfo
	(*DescribeTopicResult_TopicStats)(nil),                // 75: Ydb.Topic.DescribeTopicResult.TopicStats
	(*DescribeConsumerResult_PartitionInfo)(nil),          // 76: Ydb.Topic.DescribeConsumerResult.PartitionInfo
	(*DescribeConsumerResult_PartitionConsumerStats)(nil), // 77: Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats
	nil,                                    // 78: Ydb.Topic.AlterTopicRequest.AlterAttributesEntry
	(*Ydb_Operations.OperationParams)(nil), // 79: Ydb.Operations.OperationParams
	(*Ydb_Table.TransactionControl)(nil),   // 80: Ydb.Table.TransactionControl
	(*Ydb_Operations.Operation)(nil),       // 81: Ydb.Operations.Operation
	(*timestamp.Timestamp)(nil),            // 82: google.protobuf.Timestamp
	(*duration.Duration)(nil),              // 83: google.protobuf.Duration
	(*Ydb_Scheme.Entry)(nil),               // 84: Ydb.Scheme.Entry
	(Ydb.StatusIds_StatusCode)(0),          // 85: Ydb.StatusIds.StatusCode
	(*Ydb_Issue.IssueMessage)(nil),         // 86: Ydb.Issue.IssueMessage
}
var file_protos_ydb_topic_proto_depIdxs = []int32{
	79,  // 0: Ydb.Topic.AddOffsetsToTransactionRequest.operation_params:type_name -> Ydb.Operations.OperationParams
	80,  // 1: Ydb.Topic.AddOffsetsToTransactionRequest.tx_control:type_name -> Ydb.Table.TransactionControl
	67,  // 2: Ydb.Topic.AddOffsetsToTransactionRequest.topics:type_name -> Ydb.Topic.AddOffsetsToTransactionRequest.TopicOffsets
	81,  // 3: Ydb.Topic.AddOffsetsToTransactionResponse.operation:type_name -> Ydb.Operations.Operation
	82,  // 4: Ydb.Topic.Consumer.read_from:type_name -> google.protobuf.Timestamp
	3,   // 5: Ydb.Topic.Consumer.supported_codecs:type_name -> Ydb.Topic.SupportedCodecs
	69,  // 6: Ydb.Topic.Consumer.attributes:type_name -> Ydb.Topic.Consumer.AttributesEntry
	70,  // 7: Ydb.Topic.Consumer.consumer_stats:type_name -> Ydb.Topic.Consumer.ConsumerStats
	82,  // 8: Ydb.Topic.AlterConsumer.set_read_from:type_name -> google.protobuf.Timestamp
	3,   // 9: Ydb.Topic.AlterConsumer.set_supported_codecs:type_name -> Ydb.Topic.SupportedCodecs
	71,  // 10: Ydb.Topic.AlterConsumer.alter_attributes:type_name -> Ydb.Topic.AlterConsumer.AlterAttributesEntry
	79,  // 11: Ydb.Topic.CreateTopicRequest.operation_params:type_name -> Ydb.Operations.OperationParams
	15,  // 12: Ydb.Topic.CreateTopicRequest.partitioning_settings:type_name -> Ydb.Topic.PartitioningSettings
	83,  // 13: Ydb.Topic.CreateTopicRequest.retention_period:type_name -> google.protobuf.Duration
	3,   // 14: Ydb.Topic.CreateTopicRequest.supported_codecs:type_name -> Ydb.Topic.SupportedCodecs
	72,  // 15: Ydb.Topic.CreateTopicRequest.attributes:type_name -> Ydb.Topic.CreateTopicRequest.AttributesEntry
	13,  // 16: Ydb.Topic.CreateTopicRequest.consumers:type_name -> Ydb.Topic.Consumer
	1,   // 17: Ydb.Topic.CreateTopicRequest.metering_mode:type_name -> Ydb.Topic.MeteringMode
	81,  // 18: Ydb.Topic.CreateTopicResponse.operation:type_name -> Ydb.Operations.Operation
	79,  // 19: Ydb.Topic.DescribeTopicRequest.operation_params:type_name -> Ydb.Operations.OperationParams
	81,  // 20: Ydb.Topic.DescribeTopicResponse.operation:type_name -> Ydb.Operations.Operation
	84,  // 21: Ydb.Topic.DescribeTopicResult.self:type_name -> Ydb.Scheme.Entry
	15,  // 22: Ydb.Topic.DescribeTopicResult.partitioning_settings:type_name -> Ydb.Topic.PartitioningSettings
	74,  // 23: Ydb.Topic.DescribeTopicResult.partitions:type_name -> Ydb.Topic.DescribeTopicResult.PartitionInfo
	83,  // 24: Ydb.Topic.DescribeTopicResult.retention_period:type_name -> google.protobuf.Duration
	3,   // 25: Ydb.Topic.DescribeTopicResult.supported_codecs:type_name -> Ydb.Topic.SupportedCodecs
	73,  // 26: Ydb.Topic.DescribeTopicResult.attributes:type_name -> Ydb.Topic.DescribeTopicResult.AttributesEntry
	13,  // 27: Ydb.Topic.DescribeTopicResult.consumers:type_name -> Ydb.Topic.Consumer
	1,   // 28: Ydb.Topic.DescribeTopicResult.metering_mode:type_name -> Ydb.Topic.MeteringMode
	75,  // 29: Ydb.Topic.DescribeTopicResult.topic_stats:type_name -> Ydb.Topic.DescribeTopicResult.TopicStats
	79,  // 30: Ydb.Topic.DescribeConsumerRequest.operation_params:type_name -> Ydb.Operations.OperationParams
	81,  // 31: Ydb.Topic.DescribeConsumerResponse.operation:type_name -> Ydb.Operations.Operation
	84,  // 32: Ydb.Topic.DescribeConsumerResult.self:type_name -> Ydb.Scheme.Entry
	13,  // 33: Ydb.Topic.DescribeConsumerResult.consumer:type_name -> Ydb.Topic.Consumer
	76,  // 34: Ydb.Topic.DescribeConsumerResult.partitions:type_name -> Ydb.Topic.DescribeConsumerResult.PartitionInfo
	4,   // 35: Ydb.Topic.PartitionStats.partition_offsets:type_name -> Ydb.Topic.OffsetsRange
	82,  // 36: Ydb.Topic.PartitionStats.last_write_time:type_name -> google.protobuf.Timestamp
	83,  // 37: Ydb.Topic.PartitionStats.max_write_time_lag:type_name -> google.protobuf.Duration
	12,  // 38: Ydb.Topic.PartitionStats.bytes_written:type_name -> Ydb.Topic.MultipleWindowsStat
	79,  // 39: Ydb.Topic.AlterTopicRequest.operation_params:type_name -> Ydb.Operations.OperationParams
	16,  // 40: Ydb.Topic.AlterTopicRequest.alter_partitioning_settings:type_name -> Ydb.Topic.AlterPartitioningSettings
	83,  // 41: Ydb.Topic.AlterTopicRequest.set_retention_period:type_name -> google.protobuf.Duration
	3,   // 42: Ydb.Topic.AlterTopicRequest.set_supported_codecs:type_name -> Ydb.Topic.SupportedCodecs
	78,  // 43: Ydb.Topic.AlterTopicRequest.alter_attributes:type_name -> Ydb.Topic.AlterTopicRequest.AlterAttributesEntry
	13,  // 44: Ydb.Topic.AlterTopicRequest.add_consumers:type_name -> Ydb.Topic.Consumer
	14,  // 45: Ydb.Topic.AlterTopicRequest.alter_consumers:type_name -> Ydb.Topic.AlterConsumer
	1,   // 46: Ydb.Topic.AlterTopicRequest.set_metering_mode:type_name -> Ydb.Topic.MeteringMode
	81,  // 47: Ydb.Topic.AlterTopicResponse.operation:type_name -> Ydb.Operations.Operation
	79,  // 48: Ydb.Topic.DropTopicRequest.operation_params:type_name -> Ydb.Operations.OperationParams
	81,  // 49: Ydb.Topic.DropTopicResponse.operation:type_name -> Ydb.Operations.Operation
	35,  // 50: Ydb.Topic.StreamWriteMessage.FromClient.init_request:type_name -> Ydb.Topic.StreamWriteMessage.InitRequest
	37,  // 51: Ydb.Topic.StreamWriteMessage.FromClient.write_request:type_name -> Ydb.Topic.StreamWriteMessage.WriteRequest
	5,   // 52: Ydb.Topic.StreamWriteMessage.FromClient.update_token_request:type_name -> Ydb.Topic.UpdateTokenRequest
	85,  // 53: Ydb.Topic.StreamWriteMessage.FromServer.status:type_name -> Ydb.StatusIds.StatusCode
	86,  // 54: Ydb.Topic.StreamWriteMessage.FromServer.issues:type_name -> Ydb.Issue.IssueMessage
	36,  // 55: Ydb.Topic.StreamWriteMessage.FromServer.init_response:type_name -> Ydb.Topic.StreamWriteMessage.InitResponse
	38,  // 56: Ydb.Topic.StreamWriteMessage.FromServer.write_response:type_name -> Ydb.Topic.StreamWriteMessage.WriteResponse
	6,   // 57: Ydb.Topic.StreamWriteMessage.FromServer.update_token_response:type_name -> Ydb.Topic.UpdateTokenResponse
	39,  // 58: Ydb.Topic.StreamWriteMessage.InitRequest.write_session_meta:type_name -> Ydb.Topic.StreamWriteMessage.InitRequest.WriteSessionMetaEntry
	3,   // 59: Ydb.Topic.StreamWriteMessage.InitResponse.supported_codecs:type_name -> Ydb.Topic.SupportedCodecs
	40,  // 60: Ydb.Topic.StreamWriteMessage.WriteRequest.messages:type_name -> Ydb.Topic.StreamWriteMessage.WriteRequest.MessageData
	41,  // 61: Ydb.Topic.StreamWriteMessage.WriteResponse.acks:type_name -> Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck
	42,  // 62: Ydb.Topic.StreamWriteMessage.WriteResponse.write_statistics:type_name -> Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics
	82,  // 63: Ydb.Topic.StreamWriteMessage.WriteRequest.MessageData.created_at:type_name -> google.protobuf.Timestamp
	43,  // 64: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.written:type_name -> Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.Written
	44,  // 65: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.skipped:type_name -> Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.Skipped
	83,  // 66: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics.persisting_time:type_name -> google.protobuf.Duration
	83,  // 67: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics.min_queue_wait_time:type_name -> google.protobuf.Duration
	83,  // 68: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics.max_queue_wait_time:type_name -> google.protobuf.Duration
	83,  // 69: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics.partition_quota_wait_time:type_name -> google.protobuf.Duration
	83,  // 70: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteStatistics.topic_quota_wait_time:type_name -> google.protobuf.Duration
	2,   // 71: Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.Skipped.reason:type_name -> Ydb.Topic.StreamWriteMessage.WriteResponse.WriteAck.Skipped.Reason
	48,  // 72: Ydb.Topic.StreamReadMessage.FromClient.init_request:type_name -> Ydb.Topic.StreamReadMessage.InitRequest
	50,  // 73: Ydb.Topic.StreamReadMessage.FromClient.read_request:type_name -> Ydb.Topic.StreamReadMessage.ReadRequest
	52,  // 74: Ydb.Topic.StreamReadMessage.FromClient.commit_offset_request:type_name -> Ydb.Topic.StreamReadMessage.CommitOffsetRequest
	54,  // 75: Ydb.Topic.StreamReadMessage.FromClient.partition_session_status_request:type_name -> Ydb.Topic.StreamReadMessage.PartitionSessionStatusRequest
	5,   // 76: Ydb.Topic.StreamReadMessage.FromClient.update_token_request:type_name -> Ydb.Topic.UpdateTokenRequest
	57,  // 77: Ydb.Topic.StreamReadMessage.FromClient.start_partition_session_response:type_name -> Ydb.Topic.StreamReadMessage.StartPartitionSessionResponse
	59,  // 78: Ydb.Topic.StreamReadMessage.FromClient.stop_partition_session_response:type_name -> Ydb.Topic.StreamReadMessage.StopPartitionSessionResponse
	85,  // 79: Ydb.Topic.StreamReadMessage.FromServer.status:type_name -> Ydb.StatusIds.StatusCode
	86,  // 80: Ydb.Topic.StreamReadMessage.FromServer.issues:type_name -> Ydb.Issue.IssueMessage
	49,  // 81: Ydb.Topic.StreamReadMessage.FromServer.init_response:type_name -> Ydb.Topic.StreamReadMessage.InitResponse
	51,  // 82: Ydb.Topic.StreamReadMessage.FromServer.read_response:type_name -> Ydb.Topic.StreamReadMessage.ReadResponse
	53,  // 83: Ydb.Topic.StreamReadMessage.FromServer.commit_offset_response:type_name -> Ydb.Topic.StreamReadMessage.CommitOffsetResponse
	55,  // 84: Ydb.Topic.StreamReadMessage.FromServer.partition_session_status_response:type_name -> Ydb.Topic.StreamReadMessage.PartitionSessionStatusResponse
	6,   // 85: Ydb.Topic.StreamReadMessage.FromServer.update_token_response:type_name -> Ydb.Topic.UpdateTokenResponse
	56,  // 86: Ydb.Topic.StreamReadMessage.FromServer.start_partition_session_request:type_name -> Ydb.Topic.StreamReadMessage.StartPartitionSessionRequest
	58,  // 87: Ydb.Topic.StreamReadMessage.FromServer.stop_partition_session_request:type_name -> Ydb.Topic.StreamReadMessage.StopPartitionSessionRequest
	60,  // 88: Ydb.Topic.StreamReadMessage.InitRequest.topics_read_settings:type_name -> Ydb.Topic.StreamReadMessage.InitRequest.TopicReadSettings
	63,  // 89: Ydb.Topic.StreamReadMessage.ReadResponse.partition_data:type_name -> Ydb.Topic.StreamReadMessage.ReadResponse.PartitionData
	65,  // 90: Ydb.Topic.StreamReadMessage.CommitOffsetRequest.commit_offsets:type_name -> Ydb.Topic.StreamReadMessage.CommitOffsetRequest.PartitionCommitOffset
	66,  // 91: Ydb.Topic.StreamReadMessage.CommitOffsetResponse.partitions_committed_offsets:type_name -> Ydb.Topic.StreamReadMessage.CommitOffsetResponse.PartitionCommittedOffset
	4,   // 92: Ydb.Topic.StreamReadMessage.PartitionSessionStatusResponse.partition_offsets:type_name -> Ydb.Topic.OffsetsRange
	82,  // 93: Ydb.Topic.StreamReadMessage.PartitionSessionStatusResponse.write_time_high_watermark:type_name -> google.protobuf.Timestamp
	45,  // 94: Ydb.Topic.StreamReadMessage.StartPartitionSessionRequest.partition_session:type_name -> Ydb.Topic.StreamReadMessage.PartitionSession
	4,   // 95: Ydb.Topic.StreamReadMessage.StartPartitionSessionRequest.partition_offsets:type_name -> Ydb.Topic.OffsetsRange
	83,  // 96: Ydb.Topic.StreamReadMessage.InitRequest.TopicReadSettings.max_lag:type_name -> google.protobuf.Duration
	82,  // 97: Ydb.Topic.StreamReadMessage.InitRequest.TopicReadSettings.read_from:type_name -> google.protobuf.Timestamp
	82,  // 98: Ydb.Topic.StreamReadMessage.ReadResponse.MessageData.created_at:type_name -> google.protobuf.Timestamp
	61,  // 99: Ydb.Topic.StreamReadMessage.ReadResponse.Batch.message_data:type_name -> Ydb.Topic.StreamReadMessage.ReadResponse.MessageData
	64,  // 100: Ydb.Topic.StreamReadMessage.ReadResponse.Batch.write_session_meta:type_name -> Ydb.Topic.StreamReadMessage.ReadResponse.Batch.WriteSessionMetaEntry
	82,  // 101: Ydb.Topic.StreamReadMessage.ReadResponse.Batch.written_at:type_name -> google.protobuf.Timestamp
	62,  // 102: Ydb.Topic.StreamReadMessage.ReadResponse.PartitionData.batches:type_name -> Ydb.Topic.StreamReadMessage.ReadResponse.Batch
	4,   // 103: Ydb.Topic.StreamReadMessage.CommitOffsetRequest.PartitionCommitOffset.offsets:type_name -> Ydb.Topic.OffsetsRange
	68,  // 104: Ydb.Topic.AddOffsetsToTransactionRequest.TopicOffsets.partitions:type_name -> Ydb.Topic.AddOffsetsToTransactionRequest.TopicOffsets.PartitionOffsets
	4,   // 105: Ydb.Topic.AddOffsetsToTransactionRequest.TopicOffsets.PartitionOffsets.partition_offsets:type_name -> Ydb.Topic.OffsetsRange
	82,  // 106: Ydb.Topic.Consumer.ConsumerStats.min_partitions_last_read_time:type_name -> google.protobuf.Timestamp
	83,  // 107: Ydb.Topic.Consumer.ConsumerStats.max_read_time_lag:type_name -> google.protobuf.Duration
	83,  // 108: Ydb.Topic.Consumer.ConsumerStats.max_write_time_lag:type_name -> google.protobuf.Duration
	12,  // 109: Ydb.Topic.Consumer.ConsumerStats.bytes_read:type_name -> Ydb.Topic.MultipleWindowsStat
	26,  // 110: Ydb.Topic.DescribeTopicResult.PartitionInfo.partition_stats:type_name -> Ydb.Topic.PartitionStats
	82,  // 111: Ydb.Topic.DescribeTopicResult.TopicStats.min_last_write_time:type_name -> google.protobuf.Timestamp
	83,  // 112: Ydb.Topic.DescribeTopicResult.TopicStats.max_write_time_lag:type_name -> google.protobuf.Duration
	12,  // 113: Ydb.Topic.DescribeTopicResult.TopicStats.bytes_written:type_name -> Ydb.Topic.MultipleWindowsStat
	26,  // 114: Ydb.Topic.DescribeConsumerResult.PartitionInfo.partition_stats:type_name -> Ydb.Topic.PartitionStats
	77,  // 115: Ydb.Topic.DescribeConsumerResult.PartitionInfo.partition_consumer_stats:type_name -> Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats
	82,  // 116: Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats.partition_read_session_create_time:type_name -> google.protobuf.Timestamp
	82,  // 117: Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats.last_read_time:type_name -> google.protobuf.Timestamp
	83,  // 118: Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats.max_read_time_lag:type_name -> google.protobuf.Duration
	83,  // 119: Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats.max_write_time_lag:type_name -> google.protobuf.Duration
	12,  // 120: Ydb.Topic.DescribeConsumerResult.PartitionConsumerStats.bytes_read:type_name -> Ydb.Topic.MultipleWindowsStat
...
func file_protos_ydb_topic_proto_init() {
	...
	file_protos_ydb_topic_proto_msgTypes[38].OneofWrappers = []interface{}{
	...
	file_protos_ydb_topic_proto_msgTypes[44].OneofWrappers = []interface{}{
