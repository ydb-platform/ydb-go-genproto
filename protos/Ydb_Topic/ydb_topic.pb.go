...
type AlterConsumer struct {
	...
	//
	// Types that are assignable to AvailabilityPeriodAction:
	//
...
func (m *AlterConsumer) GetAvailabilityPeriodAction() isAlterConsumer_AvailabilityPeriodAction {
	if m != nil {
		return m.AvailabilityPeriodAction
	}
	return nil
}

func (x *AlterConsumer) GetSetAvailabilityPeriod() *durationpb.Duration {
	if x, ok := x.GetAvailabilityPeriodAction().(*AlterConsumer_SetAvailabilityPeriod); ok {
...
func (x *AlterConsumer) GetResetAvailabilityPeriod() *emptypb.Empty {
	if x, ok := x.GetAvailabilityPeriodAction().(*AlterConsumer_ResetAvailabilityPeriod); ok {
...
type AlterTopicRequest struct {
	...
	//
	// Types that are assignable to MetricsLevel:
	//
...
func (m *AlterTopicRequest) GetMetricsLevel() isAlterTopicRequest_MetricsLevel {
	if m != nil {
...
func (x *AlterTopicRequest) GetSetMetricsLevel() uint32 {
	if x, ok := x.GetMetricsLevel().(*AlterTopicRequest_SetMetricsLevel); ok {
...
func (x *AlterTopicRequest) GetResetMetricsLevel() *emptypb.Empty {
	if x, ok := x.GetMetricsLevel().(*AlterTopicRequest_ResetMetricsLevel); ok {
...
func file_protos_ydb_topic_proto_init() {
	...
	file_protos_ydb_topic_proto_msgTypes[25].OneofWrappers = []interface{}{}
	file_protos_ydb_topic_proto_msgTypes[31].OneofWrappers = []interface{}{}
	file_protos_ydb_topic_proto_msgTypes[32].OneofWrappers = []interface{}{}
