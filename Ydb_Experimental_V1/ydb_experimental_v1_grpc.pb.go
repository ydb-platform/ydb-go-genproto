...
type ExperimentalServiceClient interface {
	...
	UploadRows(ctx context.Context, in *Ydb_Experimental.UploadRowsRequest, opts ...grpc.CallOption) (*Ydb_Experimental.UploadRowsResponse, error)
	...
	GetDiskSpaceUsage(ctx context.Context, in *Ydb_Experimental.GetDiskSpaceUsageRequest, opts ...grpc.CallOption) (*Ydb_Experimental.GetDiskSpaceUsageResponse, error)
}
...
func (c *experimentalServiceClient) UploadRows(ctx context.Context, in *Ydb_Experimental.UploadRowsRequest, opts ...grpc.CallOption) (*Ydb_Experimental.UploadRowsResponse, error) {
	out := new(Ydb_Experimental.UploadRowsResponse)
	err := c.cc.Invoke(ctx, "/Ydb.Experimental.V1.ExperimentalService/UploadRows", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *experimentalServiceClient) GetDiskSpaceUsage(ctx context.Context, in *Ydb_Experimental.GetDiskSpaceUsageRequest, opts ...grpc.CallOption) (*Ydb_Experimental.GetDiskSpaceUsageResponse, error) {
	out := new(Ydb_Experimental.GetDiskSpaceUsageResponse)
	err := c.cc.Invoke(ctx, "/Ydb.Experimental.V1.ExperimentalService/GetDiskSpaceUsage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExperimentalServiceServer interface {
	// Fast bulk load rows to a table bypassing transaction logic.
	UploadRows(context.Context, *Ydb_Experimental.UploadRowsRequest) (*Ydb_Experimental.UploadRowsResponse, error)
	ExecuteStreamQuery(*Ydb_Experimental.ExecuteStreamQueryRequest, ExperimentalService_ExecuteStreamQueryServer) error
	// Returns disk space usage by database
	GetDiskSpaceUsage(context.Context, *Ydb_Experimental.GetDiskSpaceUsageRequest) (*Ydb_Experimental.GetDiskSpaceUsageResponse, error)
...
func (UnimplementedExperimentalServiceServer) UploadRows(context.Context, *Ydb_Experimental.UploadRowsRequest) (*Ydb_Experimental.UploadRowsResponse, error) {
...
func (UnimplementedExperimentalServiceServer) GetDiskSpaceUsage(context.Context, *Ydb_Experimental.GetDiskSpaceUsageRequest) (*Ydb_Experimental.GetDiskSpaceUsageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDiskSpaceUsage not implemented")
}
...
func _ExperimentalService_UploadRows_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Ydb_Experimental.UploadRowsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExperimentalServiceServer).UploadRows(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Ydb.Experimental.V1.ExperimentalService/UploadRows",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExperimentalServiceServer).UploadRows(ctx, req.(*Ydb_Experimental.UploadRowsRequest))
	}
...
func _ExperimentalService_GetDiskSpaceUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Ydb_Experimental.GetDiskSpaceUsageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExperimentalServiceServer).GetDiskSpaceUsage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Ydb.Experimental.V1.ExperimentalService/GetDiskSpaceUsage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExperimentalServiceServer).GetDiskSpaceUsage(ctx, req.(*Ydb_Experimental.GetDiskSpaceUsageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ExperimentalService_UploadRows_Handler,
		},
		{
			MethodName: "GetDiskSpaceUsage",
			Handler:    _ExperimentalService_GetDiskSpaceUsage_Handler,
		},
	},
