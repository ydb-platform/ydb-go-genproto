...
func (ActionState_ActionStatus) EnumDescriptor() ([]byte, []int) {
	return file_draft_protos_ydb_maintenance_proto_rawDescGZIP(), []int{14, 0}
}
...
func (ActionState_ActionReason) EnumDescriptor() ([]byte, []int) {
	return file_draft_protos_ydb_maintenance_proto_rawDescGZIP(), []int{14, 1}
}
...
func (x *ActionScope) GetPdisk() *ActionScope_PDisk {
	if x, ok := x.GetScope().(*ActionScope_Pdisk); ok {
		return x.Pdisk
	}
	return nil
}
...
// Deprecated: Use DrainAction.ProtoReflect.Descriptor instead.
func (*DrainAction) Descriptor() ([]byte, []int) {
...
// Deprecated: Use CordonAction.ProtoReflect.Descriptor instead.
func (*CordonAction) Descriptor() ([]byte, []int) {
...
func (x *Action) GetDrainAction() *DrainAction {
	if x, ok := x.GetAction().(*Action_DrainAction); ok {
...
func (x *Action) GetCordonAction() *CordonAction {
	if x, ok := x.GetAction().(*Action_CordonAction); ok {
...
type MaintenanceTaskResult struct {
	...
	LastRefreshTime *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=last_refresh_time,json=lastRefreshTime,proto3" json:"last_refresh_time,omitempty"`
}
...
// Deprecated: Use ActionScope_PDiskLocation.ProtoReflect.Descriptor instead.
func (*ActionScope_PDiskLocation) Descriptor() ([]byte, []int) {
...
type ActionScope_PDisk struct {
	...
	// Types that are assignable to Pdisk:
	//
	//	*ActionScope_PDisk_PdiskId
	//	*ActionScope_PDisk_PdiskLocation
	Pdisk isActionScope_PDisk_Pdisk `protobuf_oneof:"pdisk"`
}
...
// Deprecated: Use ActionScope_PDisk.ProtoReflect.Descriptor instead.
func (*ActionScope_PDisk) Descriptor() ([]byte, []int) {
	return file_draft_protos_ydb_maintenance_proto_rawDescGZIP(), []int{5, 2}
}

func (m *ActionScope_PDisk) GetPdisk() isActionScope_PDisk_Pdisk {
	if m != nil {
		return m.Pdisk
	}
	return nil
...
func (x *ActionScope_PDisk) GetPdiskId() *ActionScope_PDiskId {
	if x, ok := x.GetPdisk().(*ActionScope_PDisk_PdiskId); ok {
		return x.PdiskId
	}
	return nil
}
...
func (x *ActionScope_PDisk) GetPdiskLocation() *ActionScope_PDiskLocation {
	if x, ok := x.GetPdisk().(*ActionScope_PDisk_PdiskLocation); ok {
...
func (*ManageActionResult_Status) Descriptor() ([]byte, []int) {
	return file_draft_protos_ydb_maintenance_proto_rawDescGZIP(), []int{27, 0}
}
...
func file_draft_protos_ydb_maintenance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_draft_protos_ydb_maintenance_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActionScope_PDiskLocation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_draft_protos_ydb_maintenance_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActionScope_PDisk); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_draft_protos_ydb_maintenance_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Action_LockAction)(nil),
		(*Action_DrainAction)(nil),
		(*Action_CordonAction)(nil),
	}
	file_draft_protos_ydb_maintenance_proto_msgTypes[16].OneofWrappers = []interface{}{}
	file_draft_protos_ydb_maintenance_proto_msgTypes[21].OneofWrappers = []interface{}{}
	file_draft_protos_ydb_maintenance_proto_msgTypes[33].OneofWrappers = []interface{}{
