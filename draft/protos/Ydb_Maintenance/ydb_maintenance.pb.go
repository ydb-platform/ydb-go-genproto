...
func (x *ActionScope) GetPdisk() *ActionScope_PDisk {
	if x != nil {
		if x, ok := x.Scope.(*ActionScope_Pdisk); ok {
			return x.Pdisk
		}
	}
	return nil
...
func (x *ActionScope) HasPdisk() bool {
	...
	_, ok := x.Scope.(*ActionScope_Pdisk)
	return ok
}
...
func (x *ActionScope) ClearPdisk() {
	if _, ok := x.Scope.(*ActionScope_Pdisk); ok {
		x.Scope = nil
	}
}
...
func (b0 ActionScope_builder) Build() *ActionScope {
	...
	if b.Pdisk != nil {
		x.Scope = &ActionScope_Pdisk{b.Pdisk}
	}
	return m0
}
...
func (x *Action) GetDrainAction() *DrainAction {
	if x != nil {
		if x, ok := x.Action.(*Action_DrainAction); ok {
...
func (x *Action) GetCordonAction() *CordonAction {
	if x != nil {
		if x, ok := x.Action.(*Action_CordonAction); ok {
...
func (x *Action) SetCordonAction(v *CordonAction) {
	...
	x.Action = &Action_CordonAction{v}
}
...
func (x *Action) HasDrainAction() bool {
	...
	_, ok := x.Action.(*Action_DrainAction)
	return ok
}
...
func (x *Action) HasCordonAction() bool {
	...
	_, ok := x.Action.(*Action_CordonAction)
	return ok
}
...
func (x *Action) ClearDrainAction() {
	if _, ok := x.Action.(*Action_DrainAction); ok {
		x.Action = nil
	}
}

func (x *Action) ClearCordonAction() {
	if _, ok := x.Action.(*Action_CordonAction); ok {
		x.Action = nil
	}
}
...
func (b0 Action_builder) Build() *Action {
	...
	if b.DrainAction != nil {
		x.Action = &Action_DrainAction{b.DrainAction}
	}
	if b.CordonAction != nil {
		x.Action = &Action_CordonAction{b.CordonAction}
	}
	return m0
}
...
type ActionScope_PDisk struct {
	state protoimpl.MessageState `protogen:"hybrid.v1"`
	// Types that are valid to be assigned to Pdisk:
	//
...
func (x *ActionScope_PDisk) GetPdisk() isActionScope_PDisk_Pdisk {
	if x != nil {
		return x.Pdisk
	}
	return nil
...
func (x *ActionScope_PDisk) GetPdiskId() *ActionScope_PDiskId {
	if x != nil {
		if x, ok := x.Pdisk.(*ActionScope_PDisk_PdiskId); ok {
			return x.PdiskId
		}
	}
	return nil
...
func (x *ActionScope_PDisk) GetPdiskLocation() *ActionScope_PDiskLocation {
	if x != nil {
		if x, ok := x.Pdisk.(*ActionScope_PDisk_PdiskLocation); ok {
...
func (x *ActionScope_PDisk) SetPdiskId(v *ActionScope_PDiskId) {
	...
	x.Pdisk = &ActionScope_PDisk_PdiskId{v}
}
...
func (x *ActionScope_PDisk) SetPdiskLocation(v *ActionScope_PDiskLocation) {
	...
	x.Pdisk = &ActionScope_PDisk_PdiskLocation{v}
}
...
func (x *ActionScope_PDisk) HasPdiskId() bool {
	...
	_, ok := x.Pdisk.(*ActionScope_PDisk_PdiskId)
	return ok
}
...
func (x *ActionScope_PDisk) HasPdiskLocation() bool {
	...
	_, ok := x.Pdisk.(*ActionScope_PDisk_PdiskLocation)
	return ok
}
...
func (x *ActionScope_PDisk) ClearPdiskId() {
	if _, ok := x.Pdisk.(*ActionScope_PDisk_PdiskId); ok {
		x.Pdisk = nil
	}
}

func (x *ActionScope_PDisk) ClearPdiskLocation() {
	if _, ok := x.Pdisk.(*ActionScope_PDisk_PdiskLocation); ok {
		x.Pdisk = nil
	}
}
...
func (b0 ActionScope_PDisk_builder) Build() *ActionScope_PDisk {
	...
	_, _ = b, x
	if b.PdiskId != nil {
		x.Pdisk = &ActionScope_PDisk_PdiskId{b.PdiskId}
	}
	if b.PdiskLocation != nil {
		x.Pdisk = &ActionScope_PDisk_PdiskLocation{b.PdiskLocation}
	}
	return m0
}
