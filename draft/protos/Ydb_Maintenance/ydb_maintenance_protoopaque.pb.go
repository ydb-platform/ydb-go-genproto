...
type Node struct {
	...
	xxx_hidden_Location    *Ydb_Discovery.NodeLocation `protobuf:"bytes,4,opt,name=location"`
	xxx_hidden_State       ItemState                   `protobuf:"varint,5,opt,name=state,enum=Ydb.Maintenance.ItemState"`
...
type MaintenanceTaskOptions struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TaskUid          *string                `protobuf:"bytes,1,opt,name=task_uid,json=taskUid"`
	xxx_hidden_Description      *string                `protobuf:"bytes,2,opt,name=description"`
	xxx_hidden_AvailabilityMode AvailabilityMode       `protobuf:"varint,3,opt,name=availability_mode,json=availabilityMode,enum=Ydb.Maintenance.AvailabilityMode"`
...
func (x *MaintenanceTaskOptions) ClearAvailabilityMode() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_AvailabilityMode = AvailabilityMode_AVAILABILITY_MODE_UNSPECIFIED
}
...
type LockAction struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Scope    *ActionScope           `protobuf:"bytes,1,opt,name=scope"`
...
type CreateMaintenanceTaskRequest struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_TaskOptions     *MaintenanceTaskOptions         `protobuf:"bytes,2,opt,name=task_options,json=taskOptions"`
	xxx_hidden_ActionGroups    *[]*ActionGroup                 `protobuf:"bytes,3,rep,name=action_groups,json=actionGroups"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type RefreshMaintenanceTaskRequest struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_TaskUid         *string                         `protobuf:"bytes,2,opt,name=task_uid,json=taskUid"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type ActionUid struct {
	...
	xxx_hidden_ActionId    *string                `protobuf:"bytes,3,opt,name=action_id,json=actionId"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ActionState struct {
	...
	xxx_hidden_ActionUid     *ActionUid               `protobuf:"bytes,2,opt,name=action_uid,json=actionUid"`
	xxx_hidden_Status        ActionState_ActionStatus `protobuf:"varint,3,opt,name=status,enum=Ydb.Maintenance.ActionState_ActionStatus"`
	xxx_hidden_Reason        ActionState_ActionReason `protobuf:"varint,4,opt,name=reason,enum=Ydb.Maintenance.ActionState_ActionReason"`
	xxx_hidden_ReasonDetails *string                  `protobuf:"bytes,6,opt,name=reason_details,json=reasonDetails"`
...
func (x *ActionState) GetReasonDetails() string {
	if x != nil {
		if x.xxx_hidden_ReasonDetails != nil {
...
func (x *ActionState) ClearStatus() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
	x.xxx_hidden_Status = ActionState_ACTION_STATUS_UNSPECIFIED
}

func (x *ActionState) ClearReason() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 3)
	x.xxx_hidden_Reason = ActionState_ACTION_REASON_UNSPECIFIED
}

func (x *ActionState) ClearReasonDetails() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_ReasonDetails = nil
}
...
type ActionGroupStates struct {
	state                   protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ActionStates *[]*ActionState        `protobuf:"bytes,1,rep,name=action_states,json=actionStates"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type MaintenanceTaskResult struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TaskUid           *string                `protobuf:"bytes,1,opt,name=task_uid,json=taskUid"`
	xxx_hidden_ActionGroupStates *[]*ActionGroupStates  `protobuf:"bytes,2,rep,name=action_group_states,json=actionGroupStates"`
	xxx_hidden_RetryAfter        *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=retry_after,json=retryAfter"`
	XXX_raceDetectHookData       protoimpl.RaceDetectHookData
	XXX_presence                 [1]uint32
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
...
type GetMaintenanceTaskResult struct {
	state                        protoimpl.MessageState  `protogen:"opaque.v1"`
	xxx_hidden_TaskOptions       *MaintenanceTaskOptions `protobuf:"bytes,1,opt,name=task_options,json=taskOptions"`
	xxx_hidden_ActionGroupStates *[]*ActionGroupStates   `protobuf:"bytes,2,rep,name=action_group_states,json=actionGroupStates"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
type ListMaintenanceTasksResult struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_TasksUids []string               `protobuf:"bytes,1,rep,name=tasks_uids,json=tasksUids"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type CompleteActionRequest struct {
	state                      protoimpl.MessageState          `protogen:"opaque.v1"`
	xxx_hidden_OperationParams *Ydb_Operations.OperationParams `protobuf:"bytes,1,opt,name=operation_params,json=operationParams"`
	xxx_hidden_ActionUids      *[]*ActionUid                   `protobuf:"bytes,2,rep,name=action_uids,json=actionUids"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type ManageActionResult struct {
	state                     protoimpl.MessageState        `protogen:"opaque.v1"`
	xxx_hidden_ActionStatuses *[]*ManageActionResult_Status `protobuf:"bytes,1,rep,name=action_statuses,json=actionStatuses"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
type Node_DynamicNode struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Tenant      *string                `protobuf:"bytes,1,opt,name=tenant"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ManageActionResult_Status struct {
	state                  protoimpl.MessageState   `protogen:"opaque.v1"`
	xxx_hidden_ActionUid   *ActionUid               `protobuf:"bytes,1,opt,name=action_uid,json=actionUid"`
	xxx_hidden_Status      Ydb.StatusIds_StatusCode `protobuf:"varint,2,opt,name=status,enum=Ydb.StatusIds_StatusCode"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
