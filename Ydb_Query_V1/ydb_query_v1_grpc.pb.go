...
type QueryServiceClient interface {
	...
	AttachSession(ctx context.Context, in *Ydb_Query.AttachSessionRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Ydb_Query.SessionState], error)
	...
	ExecuteQuery(ctx context.Context, in *Ydb_Query.ExecuteQueryRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Ydb_Query.ExecuteQueryResponsePart], error)
...
func (c *queryServiceClient) CreateSession(ctx context.Context, in *Ydb_Query.CreateSessionRequest, opts ...grpc.CallOption) (*Ydb_Query.CreateSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_CreateSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) DeleteSession(ctx context.Context, in *Ydb_Query.DeleteSessionRequest, opts ...grpc.CallOption) (*Ydb_Query.DeleteSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_DeleteSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) AttachSession(ctx context.Context, in *Ydb_Query.AttachSessionRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Ydb_Query.SessionState], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &QueryService_ServiceDesc.Streams[0], QueryService_AttachSession_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Ydb_Query.AttachSessionRequest, Ydb_Query.SessionState]{ClientStream: stream}
...
type QueryService_AttachSessionClient = grpc.ServerStreamingClient[Ydb_Query.SessionState]
...
func (c *queryServiceClient) ExecuteQuery(ctx context.Context, in *Ydb_Query.ExecuteQueryRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Ydb_Query.ExecuteQueryResponsePart], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &QueryService_ServiceDesc.Streams[1], QueryService_ExecuteQuery_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Ydb_Query.ExecuteQueryRequest, Ydb_Query.ExecuteQueryResponsePart]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type QueryService_ExecuteQueryClient = grpc.ServerStreamingClient[Ydb_Query.ExecuteQueryResponsePart]
...
func (c *queryServiceClient) ExecuteScript(ctx context.Context, in *Ydb_Query.ExecuteScriptRequest, opts ...grpc.CallOption) (*Ydb_Operations.Operation, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_ExecuteScript_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) FetchScriptResults(ctx context.Context, in *Ydb_Query.FetchScriptResultsRequest, opts ...grpc.CallOption) (*Ydb_Query.FetchScriptResultsResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueryService_FetchScriptResults_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServiceServer interface {
	...
	AttachSession(*Ydb_Query.AttachSessionRequest, grpc.ServerStreamingServer[Ydb_Query.SessionState]) error
	// Short-living transactions allow transactional execution of several queries, including support
	// for interactive transactions. Transaction control can be implemented via flags in ExecuteQuery
	// call (recommended), or via explicit calls to Begin/Commit/RollbackTransaction.
	...
	// needs to be retried. For non-idempotent transaction, a custom client logic is required to
	// retry conditionally retriable statuses, when transaction execution state is unknown.
	ExecuteQuery(*Ydb_Query.ExecuteQueryRequest, grpc.ServerStreamingServer[Ydb_Query.ExecuteQueryResponsePart]) error
	// Execute long-running script.
	// YDB scripts can contain all type of statements, including TCL statements. This way you can execute multiple
	// transactions in a single YDB script.
	// ExecuteScript call returns long-running Ydb.Operation object with:
...
func (UnimplementedQueryServiceServer) AttachSession(*Ydb_Query.AttachSessionRequest, grpc.ServerStreamingServer[Ydb_Query.SessionState]) error {
...
func (UnimplementedQueryServiceServer) ExecuteQuery(*Ydb_Query.ExecuteQueryRequest, grpc.ServerStreamingServer[Ydb_Query.ExecuteQueryResponsePart]) error {
...
func (UnimplementedQueryServiceServer) FetchScriptResults(context.Context, *Ydb_Query.FetchScriptResultsRequest) (*Ydb_Query.FetchScriptResultsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchScriptResults not implemented")
}
...
func _QueryService_AttachSession_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(QueryServiceServer).AttachSession(m, &grpc.GenericServerStream[Ydb_Query.AttachSessionRequest, Ydb_Query.SessionState]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type QueryService_AttachSessionServer = grpc.ServerStreamingServer[Ydb_Query.SessionState]
...
func _QueryService_ExecuteQuery_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(QueryServiceServer).ExecuteQuery(m, &grpc.GenericServerStream[Ydb_Query.ExecuteQueryRequest, Ydb_Query.ExecuteQueryResponsePart]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type QueryService_ExecuteQueryServer = grpc.ServerStreamingServer[Ydb_Query.ExecuteQueryResponsePart]
