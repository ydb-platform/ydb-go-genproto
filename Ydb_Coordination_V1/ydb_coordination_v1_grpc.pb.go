...
type CoordinationServiceClient interface {
	...
	Session(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse], error)
...
func (c *coordinationServiceClient) Session(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CoordinationService_ServiceDesc.Streams[0], CoordinationService_Session_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CoordinationService_SessionClient = grpc.BidiStreamingClient[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse]
...
func (c *coordinationServiceClient) CreateNode(ctx context.Context, in *Ydb_Coordination.CreateNodeRequest, opts ...grpc.CallOption) (*Ydb_Coordination.CreateNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinationService_CreateNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coordinationServiceClient) AlterNode(ctx context.Context, in *Ydb_Coordination.AlterNodeRequest, opts ...grpc.CallOption) (*Ydb_Coordination.AlterNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinationService_AlterNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coordinationServiceClient) DropNode(ctx context.Context, in *Ydb_Coordination.DropNodeRequest, opts ...grpc.CallOption) (*Ydb_Coordination.DropNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinationService_DropNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coordinationServiceClient) DescribeNode(ctx context.Context, in *Ydb_Coordination.DescribeNodeRequest, opts ...grpc.CallOption) (*Ydb_Coordination.DescribeNodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoordinationService_DescribeNode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoordinationServiceServer interface {
	...
	// with a specific coordination node (previously created using CreateNode
	// below) and semaphores are local to that coordination node.
	Session(grpc.BidiStreamingServer[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse]) error
	// Creates a new coordination node
...
func (UnimplementedCoordinationServiceServer) Session(grpc.BidiStreamingServer[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse]) error {
...
func (UnimplementedCoordinationServiceServer) AlterNode(context.Context, *Ydb_Coordination.AlterNodeRequest) (*Ydb_Coordination.AlterNodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AlterNode not implemented")
}
func (UnimplementedCoordinationServiceServer) DropNode(context.Context, *Ydb_Coordination.DropNodeRequest) (*Ydb_Coordination.DropNodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DropNode not implemented")
}
...
func _CoordinationService_Session_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CoordinationServiceServer).Session(&grpc.GenericServerStream[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CoordinationService_SessionServer = grpc.BidiStreamingServer[Ydb_Coordination.SessionRequest, Ydb_Coordination.SessionResponse]
